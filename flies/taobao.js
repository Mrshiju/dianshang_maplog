var feloader = function(t) { !
  ...
  function(t) {
    ...
    function i(t, e) {
      var r, n, i = 0;
      if (l(t)) for (n = t.length; n > i && e(t[i], i, t) !== !1; i++);
      else for (r = o(t), n = r.length; n > i && e(t[r[i]], r[i], t) !== !1; i++);
    }
    function o(t) {
      var e = [];
    ...
    p = {
      ...
      function(t, e, r) {
        ...
        for (var n = t.length,
        i = new Array(n), o = 0; n > o; o++) {
          var a = "string" == typeof t ? t.charAt(o) : t[o]; (a || o in t) && e.call(r || this, a, o, t) && i.push(a)
        }
        return i
      },
      map: d ?
      function(t, e, r) {
        ...
        for (var n = t.length,
        i = new Array(n), o = 0; n > o; o++) {
          var a = "string" == typeof t ? t.charAt(o) : t[o]; (a || o in t) && (i[o] = e.call(r || this, a, o, t))
        }
        return i
      },
      startsWith: g ?
    ...
    m = function() {
      ...
      l = n.Utils = {},
      f = c.document,
      d = (c.navigator || {}).userAgent || ""; ((t = d.match(/Web[Kk]it[\/]{0,1}([\d.]*)/)) || (t = d.match(/Safari[\/]{0,1}([\d.]*)/))) && t[1] && (l.webkit = r(t[1])),
      (t = d.match(/Trident\/([\d.]*)/)) && (l.trident = r(t[1])),
      (t = d.match(/Gecko/)) && (l.gecko = .1, (t = d.match(/rv:([\d.]*)/)) && t[1] && (l.gecko = r(t[1]))),
      (t = d.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (e = t[1] || t[2]) && (l.ie = r(e), l.ieMode = f.documentMode || l.ie, l.trident = l.trident || 1),
      a(l, p),
      a(l, {
        mix: a,
        docHead: function() {
        ...
        collectErrors: function(t, e, r) {
          var n, i, a, s;
          for (r = r || {},
          e = e || [], n = 0; n < t.length; n++) a = t[n],
          i = a.id,
          r[i] || (r[i] = 1, s = a.status, s !== o.ERROR ? l.collectErrors(a.getNormalizedRequiredModules(), e, r) : e.push(a));
          return e
        },
        createModule: function(t, e) {
          ...
          var r = u[t];
          return r || (r = u[t]),
          r ? (e && r.reset(e), r) : (u[t] = r = new n.Module(a({
            id: t
          },
          e)), r)
        },
        ...
        getModulesExports: function(t) {
          for (var e = t.length,
          r = [], n = 0; e > n; n++) r.push(t[n].getExports());
          return r
        },
  ...
  function(t, e) {
    ...
    function o(t, r) {
      ...
      u.toUrl = function(t) {
        ...
        i = e,
        o = e.indexOf("//");
        return - 1 !== o && (r = e.slice(0, o + 2), i = e.slice(o + 2)),
    ...
    function s(t, e) {
      t = t || [];
      for (var r = t.length,
      n = 0; r > n; n++) t[n] = e.resolve(t[n]).id;
      return t
    }
    function u(t) {
      var e, r = t.id,
    ...
    o.prototype = {
      ...
      flush: function() {
        this.ctx.Loader.Utils.each(this.waits,
        function(t) {
          t.flush()
        }),
        this.waits = {}
      ...
      getAlias: function() {
        ...
        n = [];
        if (r[0] === e) n = r;
        else if (r.length > 1) for (var i = 0,
        o = r.length; o > i; i++) {
          var a = r[i];
          if (a && a !== e) {
      ...
      getPackage: function() {
        ...
        if (a[u]) return t.packageInfo = a[u],
        t.packageInfo;
        u = "";
        var c;
        for (c in a) {
      ...
      setRequiresModules: function(t) {
        var e = this,
        r = e.requiredModules = e.ctx.Loader.Utils.map(s(t, e),
        function(t) {
          return e.ctx.Loader.Utils.createModule(t)
        }),
        n = [];
        this.ctx.Loader.Utils.each(r,
        function(t) {
      ...
      callFactory: function() {
        var t = this;
        return t.factory.apply(t, t.cjs ? [t._require, t.exports, t] : t.ctx.Loader.Utils.map(t.getRequiredModules(),
        function(t) {
          return t.getExports()
        }))
      },
      initSelf: function() {
        ...
        n = r.factory,
        i = this.ctx.Config,
        o = this.ctx.Loader.Status,
        a = this.ctx.Loader.Utils;
        if ("function" == typeof n) {
          if (r.exports = {},
          i.debug) t = r.callFactory();
          else {
            try {
              t = r.callFactory()
            } catch(s) {
            ...
            var c = 1;
            if (a.each(r.getNormalizedRequiredModules(),
            function(t) {
      ...
      initRecursive: function() {
        ...
        return r === n.ERROR ? 0 : r >= n.INITIALIZING ? e: (t.status = n.INITIALIZING, t.cjs ? e = t.initSelf() : (i.each(t.getNormalizedRequiredModules(),
        function(t) {
          e = e && t.initRecursive()
        }), e && t.initSelf()), e)
      },
  ...
  function(t) {
    var e = function() {
      ...
      this.getScript = function(r, u, c) {
        ...
        c && (x.charset = c),
        y ? (x.href = r, x.rel = "stylesheet") : (x.src = r, x.async = !0, v && x.setAttribute("crossorigin", "anonymous")),
        g.node = x;
        var b = function(t) {
          var e, n = t;
          M(),
          i.each(a[r],
          function(t) { (e = t[n]) && e.call(x)
          }),
          delete a[r]
        },
        E = "onload" in x,
        ...
        return y && L && E && (E = !1),
        E ? (x.onload = l, x.onerror = function() {
          x.onerror = null,
          b(1)
        }) : y ? i.pollCss(x,
        function() {
  ...
  function(t, e) {
    ...
    var n = function() {
      ...
      c.resolveModFn = function(t) {
        ...
        return o = t.getType(),
        i = "." + o,
        u || (s.endsWith(a, i) && (a = a.slice(0, -i.length)), e = c.getFilter() || "", "function" == typeof e ? u = e(a, o) : "string" == typeof e && (e && (e = "-" + e), u = a + e + i)),
        "core" === h ? r = d + u: a === h ? r = d.substring(0, d.length - 1) + e + i: (c.isIgnorePackageNameInUri() && (u = u.substring(h.length + 1)), r = d + u),
        n(r, t, i)
      },
  ...
  function(t, e) {
    ...
    function i(t, e) {
      var r = t.indexOf("//"),
      n = ""; - 1 !== r && (n = t.substring(0, t.indexOf("//") + 2)),
    ...
    function o(t, e, r, n, i, o) {
      if (t && e.length > 1) {
        for (var a = t.length,
        s = [], u = 0; u < e.length; u++) s[u] = e[u].substring(a);
    ...
    var a = function() {
      function t(t, r, n) {
        ...
        function(t) {
          var r, o = {
            ...
            success: function() {
              s.push(t),
              r && u && (p(r.id, u.factory, u.config), u = e),
              i()
            },
            error: function() {
              a.push(t),
          ...
          t.combine || (r = t.mods[0], "css" === r.getType() ? r = e: b && (c = r.id, o.attrs = {
            "data-mod-id": r.id
          })),
          d.loadModsFn(t, o)
        })
      ...
      g.mix(a.prototype, {
        use: function(e) {
          for (var r, n = this,
          i = d.timeout,
          o = [], a = 0; a < e.length; a++) e[a].id && o.push(e[a]);
          e = o,
          r = n.getComboUris(e),
          r.css && t(r.css,
          function(t, e) {
        ...
        calculate: function(t, e, r, n, i) {
          var o, a, s, u, c = this;
          for (i = i || [], n = n || {},
          o = 0; o < t.length; o++) if (s = t[o], a = s.id, !n[a]) if (u = s.status, u !== M) if (d.requireModsPre && c.calculate(s.getNormalizedRequiredModules(), e, r, n, i), u > x) n[a] = 1;
          else {
            u === x || s.contains(c) || (u !== y && (s.status = y, i.push(s)), s.add(c), c.wait(s)),
        ...
        getComboMods: function(t) {
          var e, r, n, o, a, s, u, c, l, f, d, h = t.length,
          p = {},
          m = {};
          for (e = 0; h > e; ++e) if (n = t[e], a = n.getType(), d = n.getUri(), o = n.getPackage(), o ? (c = o.getBase(), l = o.name, u = o.getCharset(), s = o.getTag(), f = o.getGroup()) : c = n.id, o && o.isCombine() && f) {
            ...
            var b = m[a] || (m[a] = {}); (r = b[c]) ? s && s !== r.tag && (r.tag = v(r.tag + s)) : (r = b[c] = [], r.charset = u, r.tag = s || ""),
            r.push(n)
          }
          return {
            groups: p,
        ...
        getComboUris: function(t) {
          function r(t, r, n) {
            ...
            for (var m, v = [], y = [], x = n.tag, M = n.charset, b = x ? "?t=" + encodeURIComponent(x) + "." + t: "", E = r.length, L = [], k = 0; k < n.length; k++) {
              ...
              if (q.getPackage() && q.getPackage().isCombine() && g.startsWith(w, r)) {
                ...
                v.push(I),
                y.push(q),
                m === e ? m = -1 !== I.indexOf("/") ? I: "": "" !== m && (m = i(m, I), "/" === m && (m = "")),
                (v.length > f || p().length > h) && (v.pop(), y.pop(), s(p()), v = [], y = [], m = e, k--)
              } else L.push({
                combine: 0,
                uri: a(w),
                charset: M,
          ...
          var n, a, s, u = d.comboPrefix,
          c = d.comboSep,
          l = {},
          f = d.comboMaxFileNum,
          h = d.comboMaxUriLength,
          p = this.getComboMods(t),
          m = p.normals,
          v = p.groups;
          for (n in m) {
            l[n] = l[n] || [];
  ...
  function(t) {
    var e = function() {
      ...
      r.mix(this, {
        ...
        use: function(e, n, o) {
          function a(e, n) {
            if (console.error("feloader: " + n + " the following modules error"), console.error(r.map(e,
            function(t) {
              return t.id
            })), o) {
              try {
          ...
          for (var l = 0; l < e.length; l++) {
            var f = e[l]; (r.startsWith(f, "./") || r.startsWith(f, "../")) && (e[l] = r.normalizePath(location.href, f))
          }
  ...
  function(t) {
    ...
    a = function(t, e) {
      ...
      a = a ? o(a) : {};
      var s, u, c = a.comboPrefix,
      l = a.comboSep,
      f = i.indexOf(c);
      if ( - 1 === f) u = i.replace(r, "$1");
      else {
        u = i.substring(0, f),
    ...
    function() {
      ...
      var o, a, s, u = "undefined" != typeof window && window.document,
      c = !u,
      l = u ? document: null,
      f = [];
      if (u) {
  ...
  function() {
    ...
    i = e.loadedCss,
    t = e.seed;
    if (i && i.length) for (var n = 0; n < i.length; n++) feloader.add(i[n],
    function() {});
    t && (t.combine = !0, feloader.config(t)),
    window.location.href.indexOf("wh_debugger=true") >= 0 ? feloader.config("combine", !1) : feloader.config("combine", !0)
  } (),
  define("detail-m/common/js/mod-config.js",
  function() {});
  define("mui/babel-polyfill/index",
  function() {}); (function t(n, e, r) {
    function i(u, f) {
      if (!e[u]) {
        if (!n[u]) {
    ...
    16 : [function(t, n, e) {
      ...
      n.exports = function(t, n, e, p, v, g) {
        ...
        if (typeof y != "function" || !(g || w.forEach && !s(function() { (new y).entries().next()
        }))) {
    ...
    86 : [function(t, n, e) {
      ...
      var C = function(t, n) {
        return function(e) {
          ...
          while (n > i) if (a(r, u = t[i++])) {~E(o, u) || o.push(u)
          }
          return o
        }
      };
      var G = function() {};
      i(i.S, "Object", {
        getPrototypeOf: r.getProto = r.getProto ||
        function(t) {
          t = d(t);
          if (a(t, x)) return t[x];
    ...
    115 : [function(t, n, e) {
      ...
      if (!l(" 0o1") || !l("0b1") || l("+0x1")) {
        ...
        r.each.call(t(20) ? r.getNames(h) : ("MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY," + "EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER," + "MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger").split(","),
        function(t) {
          if (o(h, t) && !o(l, t)) {
    ...
    138 : [function(t, n, e) {
      ...
      if (i + "" != "[object z]") {
        t(62)(Object.prototype, "toString",
        function o() {
    ...
    142 : [function(t, n, e) {
      ...
      o = t(5);
      i(i.S + i.F * t(25)(function() {
        Reflect.defineProperty(r.setDesc({},
        1, {
          value: 1
        }), 1, {
          value: 2
    ...
    171 : [function(t, n, e) {
      ...
      if ((new h).set((Object.freeze || Object)(l), 7).get(l) != 7) {
        r.each.call(["delete", "has", "get", "set"],
        function(t) {
          var n = h.prototype,
          e = n[t];
          i(n, t,
    ...
    190 : [function(t, n, e) { (function(t) { !
        function(t) {
          ...
          function m(t) { ["next", "throw", "return"].forEach(function(n) {
              t[n] = function(t) {
  ...
  function() {
    function e(e, i, t) {
      if ("string" == typeof e) {
        "object" === (void 0 === i ? "undefined": _typeof(i)) && (t = i, i = "bat"),
        i = "bat" === e ? "": i || "bat",
        t = t || {},
        t.module = t.module || "",
    ...
    function t(e, i) {
      return i = i || "",
      e ? t(--e, "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz".charAt(Math.floor(60 * Math.random())) + i) : i
    }
    function n(e, i, t) {
    ...
    function a() {
      ...
      var e = "",
      i = "";
      if (window.goldlog && window.goldlog.spm_ab) return e = window.goldlog.spm_ab.join(".").split("/")[0],
      e = e.split("-")[0];
    ...
    function u(e) {
      var i, t, o, a = [];
      for (i = 0, t = e.length; i < t; i++) o = e[i],
      "object" === (void 0 === o ? "undefined": _typeof(o)) ? a.push(JSON.stringify(o)) : null === o || o === undefined ? a.push("") : a.push(o + "");
      for (i = a.length; i--;) a[i] = n(n(a[i], "|", "\u4e28"), ";", "\uff1b");
      return a
    }
    function r() {
      for (var e = 0,
      i = new Array(256), t = 0; 256 !== t; ++t) {
        e = t;
    ...
    function d(e) {
      for (var i, t, n = -1,
      o = 0,
      a = e.length; o < a;) i = e.charCodeAt(o++),
      i < 128 ? n = n >>> 8 ^ N[255 & (n ^ i)] : i < 2048 ? (n = n >>> 8 ^ N[255 & (n ^ (192 | i >> 6 & 31))], n = n >>> 8 ^ N[255 & (n ^ (128 | 63 & i))]) : i >= 55296 && i < 57344 ? (i = 64 + (1023 & i), t = 1023 & e.charCodeAt(o++), n = n >>> 8 ^ N[255 & (n ^ (240 | i >> 8 & 7))], n = n >>> 8 ^ N[255 & (n ^ (128 | i >> 2 & 63))], n = n >>> 8 ^ N[255 & (n ^ (128 | t >> 6 & 15 | (3 & i) << 4))], n = n >>> 8 ^ N[255 & (n ^ (128 | 63 & t))]) : (n = n >>> 8 ^ N[255 & (n ^ (224 | i >> 12 & 15))], n = n >>> 8 ^ N[255 & (n ^ (128 | i >> 6 & 63))], n = n >>> 8 ^ N[255 & (n ^ (128 | 63 & i))]);
      return - 1 ^ n
    }
    function l() {
      try {
        if (!b) return [];
        window.localStorage.removeItem("ctk_full_queue"),
        window.localStorage.removeItem("bat_full_queue"),
        window.localStorage.removeItem("spy_full_queue"),
        window.localStorage.removeItem("tes_full_queue"),
        window.localStorage.removeItem("dom_full_queue");
    ...
    function m(e, i) {
      try {
        ...
        n[e] = i,
        n.time = +new Date,
        window.localStorage.setItem("bat", JSON.stringify(t))
      } catch(o) {}
    }
    function c(e) {
    ...
    function p(e) {
      ...
      this.version = "4.0.40",
      this.api = e.api || "",
      this.chksum = e.chksum || "",
      this.name = e.name || "none",
      this.sender = e.sender ||
      function() {},
      this.queueName = e.name + "_queue",
      this.fullQueueName = e.name + "_full_queue",
      this.onloaded = !1,
      ...
      this.unloadFns = [],
      this.bindEvent(),
      this.setQueue(window[this.queueName] || []);
      try {
      ...
      window[e.name + "TrackIme"] = function() {
        i.sender.apply(i, Array.prototype.slice.call(arguments)),
        i.sendingTask && clearTimeout(i.sendingTask),
        i.sendQueue()
      }
    }
    function f(e) {
    ...
    function x(e) {
      e = e || "",
      e = e.split("\n").slice(1, 3);
      for (var i = e.length; i--;) e[i] = f(e[i]).replace(/\((.*)\)/,
      function(e, i) {
        return i = i.split(":"),
        "(" + [Number(i[2]) || 0, Number(i[3]) || 0].join(":") + ")"
      });
      return e.join("^")
    }
    function v(e) {
    ...
    if ("function" != typeof window.batTrack) {
      var g = window.batSamplingFile || "",
      y = window.batIntervalAfterOnload || 1500,
      k = window.batProxy || "",
      b = !1;
      try {
        localStorage.batLocalTest = 0,
        "0" === localStorage.batLocalTest && (b = !0, localStorage.removeItem("batLocalTest"))
      } catch(Q) {}
      var w = 1700,
      q = window.location.host + window.location.pathname,
      z = window.batUrlBaseHost || "gm.mmstat.com",
      ...
      A = 864e5,
      _ = 0,
      T = /(iPhone|iPad|iPod|iOS|Android)/i.test(window.navigator.userAgent),
      D = t(20),
      C = "",
      O = [],
      M = null;
      ...
      p.prototype.bindEvent = function() {
        function e() {
          if (!o.onloaded) {
            ...
            o.onloadFns = [],
            window.detachEvent ? window.detachEvent("onload", t) : (document.removeEventListener("WindVaneReady", i, !1), window.removeEventListener("load", t, !1)),
            o.waitSendStart()
          }
        }
        function i() {
        ...
        if (window.addEventListener) {
          var u;
          document.addEventListener("WindVaneReady", i, !1),
      ...
      p.prototype.sendStart = function() {
        ...
        e.sendingTask || (e.sendingTask = setTimeout(function() {
          e.sendQueue(),
          e.sendingTask = null,
          (e.queue.length > 0 || e.fullQueue.length > 0) && e.waitSendStart()
        },
        y))
      },
      ...
      p.prototype.sendQueue = function() {
        this.setQueue(this.formatQueue(this.queue)),
        this.setFullQueue(this.formatQueue(this.fullQueue)),
        this.sendNormalQueue(),
        this.sendFullQueue()
      },
      ...
      p.prototype.mergeQueue = function(e) {
        ...
        for (i = 0, t = e.length; i < t; i++) {
          ...
          try {
            ...
            r[n].length += a.length,
            Math.random() * r[n].length <= a.length && (r[n].point = a.point)
          } catch(Q) {
            continue
          }
        }
      ...
      p.prototype.sendFullQueue = function() {
        ...
        for (i = [].concat(this.fullQueue), this.setFullQueue(i); i.length;) try {
          var o = i[0],
          a = I(u([].concat(o.point.slice(1)).concat([o.length])).join("|")).length;
      ...
      p.prototype.send = function(e) {
        if (e) {
          ...
          if (i) {
            ...
            var o = t.join("&");
            if (window.goldlog && window.goldlog.record && "function" == typeof window.goldlog.record) window.goldlog.record(this.api, "EXP", o, this.chksum);
            else {
              var n = "__CT_image_" + _++,
              u = window[n] = new Image;
      ...
      U = new p({
        "name": "spy",
        "sender": function(e, i, t) {
          i = i || "",
          t = t || !1,
          e && (t ? this.pushFull([e, i, +new Date - P]) : this.push([e, i, +new Date - P]))
        },
        "api": "/codetrack.1.2",
        "chksum": "H46836987"
      }),
      V = new p({
        ...
        "sender": function(e, i, t) {
          i = i || [],
          t = t || !1,
          e && (t ? this.pushFull([].concat([e]).concat(i)) : this.push([].concat([e]).concat(i)))
        },
        "api": "/codetrack.1.3",
        "chksum": "H46836988"
      }),
      ...
      window.addEventListener ? window.addEventListener("error", h, !1) : window.attachEvent("error", h),
      window.batTrack("bat", ""),
      window.batIns = {
        "bat": B,
        "tes": V,
  ...
  function(e, i) {
    "function" == typeof define && define.amd ? define("@ali/mui-bat/index", [],
    function() {
      return e.bat = i()
  ...
  WindowTes = function(e) {
    ...
    n(12),
    n(13),
    (0, i(n(10))["default"])(function() { - 1 === navigator.userAgent.indexOf("AliApp(") && TES.timing(),
      Math.random() < (window.TES_SAMPLING || .01) && (TES.longTask(), TES.tsl(), TES.animFPS(), TES.invalidClick(), TES.scrollFPS(), TES.evn())
    })
  },
  function(e, t) {
    window.TES = {
    ...
    TES.send = function(e, t, n, i) {
      ...
      if (i && window.tesTrackIme) tesTrackIme(e + t[0], [e].concat(t), n);
        ...
        var a = "tes_queue";
        n && (a = "tes_full_queue"),
        (window[a] || (window[a] = [])).push([e + t[0], e].concat(t))
      }
    },
  ...
  function(e, t, n) {
    ...
    l = window.cancelAnimationFrame || window.webkitCancelAnimationFrame,
    m = {},
    p = {},
    v = function() {
      return window.performance && performance.now ? performance.now() : Date.now()
    },
    g = window.requestIdleCallback ||
    function(e) {
      e()
    },
    h = function(e) {
    ...
    TES.fpsEnd = function(e) {
      if (l) {
        l(m[e]);
        var t = p[e];
        t && t.length && this.send(e, ["fps"].concat(o(h(t)))),
        delete p[e],
        delete m[e]
      }
    },
  ...
  function(e, t, n) {
    ...
    e.exports = function(e, t) {
      ...
      if (window.addEventListener("pagehide", n = function(e) {
        e && window.removeEventListener("pagehide", n),
        r()
      }), i.supportVisiblityChange) {
        var a;
        document.addEventListener(i.visibilitychangeMap.visibilityChange, a = function(e) {
          t && document.removeEventListener(i.visibilitychangeMap.visibilityChange, a),
          document[i.visibilitychangeMap.hidden] && r()
        })
      }
    }
  },
          ...
          var n = function(e) {
            ...
            n = setTimeout(function() {
              ...
              function() {
                ...
                var t, n = (0, r["default"])(e.path || e.target); (0, u["default"])(function() {
                  clearTimeout(t)
                },
                !0),
  ...
  function(e, t) {
    TES.time = function(e) {
      this._timeRecord || (this._timeRecord = {}),
      this._timeRecord[e] = Date.now()
    },
  ...
  function(e, t, n) {
    ...
    a = n(3);
    i(a);
    TES.evn = function() { (0, r["default"])(function() {
        var e = function() {
  ...
  function(e, t) {
    e.exports = function(e) {
      ...
      if (window.__windvane__) if (window._WindVaneReady) e();
      else {
        var n = void 0;
        document.addEventListener("WindVaneReady", n = function() {
          window._WindVaneReady = !0,
          document.removeEventListener("WindVaneReady", n),
          e()
        })
      ...
      if (window.PerformanceLongTaskTiming) {
        ...
        new PerformanceObserver(function(t) {
          t.getEntries().forEach(function(t) {
            TES.send("longtask_" + e, ["longtask", t.startTime, t.duration]),
            e++
          })
        }).observe({
          "entryTypes": ["longtask"]
      ...
      if (window.PerformanceTouchScrollLatencyTiming) {
        ...
        new PerformanceObserver(function(n) {
          n.getEntries().forEach(function(n) {
            t++,
            n.duration > 100 && (e++, TES.send("tsl_" + e, ["tsl", n.name, n.startTime, n.duration, t, e]))
          })
        }).observe({
  ...
  function(e, t) {
    "function" == typeof define && define.amd ? define("mui/tes/index", [],
    function() {
      return e.TES = t()
  ...
  function(e) {
    var t = e.Ali = e.Ali || {};
    if (t.event && t.callAfterReady && t.version && t.reg) return void(e.KISSY && KISSY.add ? (KISSY.add("mui/hybrid/index",
    function() {
      return t
    }), KISSY.add("@ali/mui-hybrid/index",
    function() {
      return t
    ...
    t.isYitao = !1,
    t.isWeb = !0,
    t.isIOS = /iphone|ipad|ipod/i.test(t.ua),
    t.isAndroid = /android/i.test(t.ua),
    t.version = "4.0.40",
    t._noSuchApi = function(e) {
      e && e({
        "errorCode": 1,
        "errorMessage": "\u63a5\u53e3\u4e0d\u5b58\u5728"
      })
    ...
    i = function(e, i) {
      var o = {};
      e ? t._resolvePath(e, o, i(t)) : o = i(t),
      n(t, o)
    };
    t.reg = function(e, n) {
      "function" == typeof e && (n = e, e = ""),
      t._isInit ? i(e, n) : t.event.add("init",
      function() {
        i(e, n)
      })
    };
    var o = function(e, i) {
      e = e.split(".");
      for (var o = t,
      r = 0; r < e.length - 1; r++) o = o[e[r]];
      e = e[r];
      for (var a = "_ori_" + e; o[a];) e = a,
      a += "_";
      o[a] = o[e],
      o[e] = function() {
    ...
    t.regProxy = function(e, n) {
      t._isInit ? o(e, n) : t.event.add("inited",
      function() {
        o(e, n)
      })
    },
    ...
    l = function(e) {
      return t.regProxy(e,
      function(e) {
        return /^pre_/.test(e[0]) && (e[0] = t._store.get(e[0])),
        e
      }),
      s(e)
    },
    f = t._preRegAPI = function(e) {
      var n;
      n = /\.watch/.test(e) ? d(e) : /\.clearWatch/.test(e) ? l(e) : s(e),
      n.__is_pre_reg = !0,
      t._resolvePath(e, t, n, !0)
    };
    ...
    function(e) {
      ...
      function n(e) {
        ...
        else if (/Safari/.test(e) && /Android[\s\/]([\d\.]+)/.test(e)) n.version = RegExp.$1,
        /Mobile\s+Safari/.test(e) ? (n.name = "Android", n.isAndroid = !0) : (n.isAndroid = !0, n.name = "AndroidPad", n.isAndroidPad = !0);
      ...
      function i(e) {
        ...
        },
        {
          "name": "Chrome",
          "reg": /(?:Chrome|CriOS)\/([\d\.]+)/,
          "fn": function(t) { / Version\ / [\d + \.] + \s * Chrome / .test(e) && (t.name = "Chrome Webview", t.isWebview = !0)
          }
        },
        {
          "name": "Android",
        ...
        },
        {
          ...
          "fn": function(t) { / Safari / .test(e) && /Version\/([\d\.]+)/.test(e) ? (t.name = "Safari", t.version = RegExp.$1, t.isSafari = !0) : /OS ([\d_\.]+) like Mac OS X/.test(e) && (t.name = "iOS Webview", t.version = RegExp.$1, t.isWebview = !0)
          }
        }], o = 0; o < i.length; o++) if (i[o].reg.test(e)) {
          n.version = RegExp.$1,
          n.version && (n.name = i[o].name, n["is" + i[o].name] = !0),
          i[o].fn && i[o].fn(n);
          break
        }
        return n.version = t(n.version),
      ...
      function r() {
        for (var e = location.search.split(/[?&]/).slice(1), t = {},
        n = 0; n < e.length; n++) {
          var i = e[n].split("=");
          try {
    ...
    t._config.platform = {
      ...
      "tmall": {
        "detect": function(e) {
          var n = /AliApp\(TM\/([\d\.]+)\)/i.exec(e),
          i = n && n[1];
          return t.isIOS,
          n && t._versionCompare(i, "5.30.0") < 0
        }
      },
      "tmall2": {
        "detect": function(e) {
    ...
    for (var m in t._config.platform) {
      ...
      g[m] && (h.res = g[m].res, h.detect = g[m].detect || h.detect),
    ...
    y.set = function(e, n) {
      return void 0 === n && (n = e, e = t._getCUID()),
      _[e] = n,
      e
    },
    y.remove = function(e) {
    ...
    function(e) {
      e.appinfo = e.appinfo || {},
      e.appinfo.name = e.appinfo.name || "web",
      e.appinfo.ver = e.appinfo.ver || "1.0.0",
      e.appinfo.engine = e.appinfo.engine || e.appinfo.name,
      e.appinfo.engineVer = e.appinfo.engineVer || e.appinfo.ver
    }),
    t.reg("app",
    function() {
      function n(e) {
      ...
      function o(e) {
        c || (c = document.createElement("iframe"), c.id = "callapp_iframe_" + Date.now(), c.frameborder = "0", c.style.cssText = "display:none;border:0;width:0;height:0;", document.body.appendChild(c)),
        c.src = e
      }
      function r(t, n, o) {
        t = t.split(":");
        var r = t[0];
        t = "intent:" + t.slice(1).join(":"),
        t += "#Intent;scheme=" + r + ";",
        t += "package=" + n + ";end",
        o ? e.open(t) : i(t)
      }
      ...
      var c, u = t.env,
      s = u.os.isAndroid && u.browser.isChrome && !u.browser.isWebview,
      d = parseFloat(u.os.version),
      l = u.os.isAndroid && /samsung/i.test(t.ua) && d >= 4.3 && d < 4.5,
      ...
      return {
        "open": function(e, t) {
          ...
          e.rafTimeout = e.rafTimeout || 300,
          e.timeout = e.timeout || (u.os.isIOS ? 4e3: 3e3),
          a(e.rafTimeout, e.timeout, t),
          s || l || e.useIntent ? r(e.url, e.pkg, e.useWindowOpen) : f ? n(e.url) : o(e.url)
        },
        "_openWithAnchorLink": n,
        "_openWithLocation": i,
        "_openWithIframe": o,
        "_openWithIntent": r
      }
    ...
    t.reg(function() {
      return {
        "toast": function(t, n) {
          ...
          i.className = "hybrid-toast",
          i.style.cssText = "position:fixed;top:70%;left:50%;z-index: 2147483647;-webkit-transform: translate(-50%,-50%);transform: translate(-50%,-50%);max-width: 60%;font-size: " + e.innerWidth / 32 + "px;padding: .5em;line-height: 1.2em;color: #FFF;text-align: center;word-break: break-all;border-radius: 3px;background: rgba(0, 0, 0, 0.8);",
          i.innerText = t.text,
        ...
        "showTitle": t._noSuchApi,
        "hideTitle": t._noSuchApi,
        "showLoading": function(e, n) {
          t._noSuchApi(n)
        },
        "hideLoading": t._noSuchApi,
        "popWindow": function(e, n) {
          t._noSuchApi(e)
        },
        "popTo": function(e, n) {
          t._noSuchApi(n)
        ...
        "login": function() {
          ...
          e = e && e[0] || "m";
          var n = "//login.taobao.com/member/login.jhtml?redirectURL="; (t.isIOS || t.isAndroid) && (n = -1 !== location.host.indexOf("tmall") && "m" === e ? "//login.tmall.com?redirectURL=": "//login." + e + ".taobao.com/login.htm?redirectURL="),
          location.href = n + encodeURIComponent(location.href)
        },
        ...
        "scanCode": function(e, n) {
          t.scan ? (e = e || {},
          e.type = e.type || "qr", t.scan(e,
          function(e) {
            e = e || {},
            e.code = e.code || e.qrCode || e.barCode || e.cardNumber,
            n(e)
          })) : t._noSuchApi(n)
        },
        "getUtdid": function(e) {
    ...
    function() {
      return function(e, t) {
        ...
        e && e.text && (document.title = e.text),
        t && t({})
      }
    }),
    t.reg("share.type",
    ...
    function() {
      return function(n, i) {
        if (!e.lib || "function" != typeof lib.mtop) return t._isLoadingMtopJS || (t._isLoadingMtopJS = !0, t._loadScripts(["//g.alicdn.com/mtb/??lib-promise/3.1.1/polyfillB.js,lib-mtop/2.4.2/mtop.js"],
        function() {
          t._isLoadingMtopJS = !1,
          t.event.trigger("mtop:loaded")
        })),
        void t.event.add("mtop:loaded",
        function() {
          t.mtop(n, i)
        });
        n.timeout = n.timeout || n.timer,
        n.data = n.data || n.param,
        n.dataType = "jsonp",
        -1 !== location.hostname.indexOf(".liangxinyao.") && (lib.mtop.config.mainDomain = "liangxinyao.com"),
        lib.mtop.request(n,
        function(e) {
          if (e = e || {},
          n.isFormatString) try {
            var t = /:\s*"(0|false|true|[1-9]\d*)"/g,
            o = JSON.stringify(e).replace(t, ":$1");
            e = JSON.parse(o)
          } catch(r) {}
        ...
        function(e) {
          e = e || {},
          e.errorCode = Number(e.retType) || 6,
          i(e)
        })
      }
    }),
    ...
    function(e) {
      return {
        ...
        "askAuth": e._noSuchApi,
        "getAuthStatus": e._noSuchApi
      }
    }),
    t.reg("network",
    function(e) {
      ...
      return {
        ...
        "watch": function(o) {
          ...
          if (i) {
            ...
            r = t.set(a),
            i.addEventListener("typechange", a)
          } else e._noSuchApi(o);
          return r
        },
        "clearWatch": function(e, n) {
          var o = t.get(e);
          i && o && (i.removeEventListener("typechange", o), t.remove(e)),
          n && n({})
        }
      }
    }),
    t.reg("vibration.vibrate",
    function(t) {
      return navigator.vibrate = navigator.vibrate || navigator.weblibkitVibrate || navigator.mozVibrate || navigator.msVibrate,
      navigator.vibrate || (e.Notification && Notification.vibrate ? navigator.vibrate = Notification.vibrate: navigator.notification && navigator.notification.vibrate && (navigator.vibrate = navigator.notification.vibrate)),
      function(e, n) {
        var i = {};
        navigator.vibrate ? navigator.vibrate(e.duration || e) : t._noSuchApi(n),
        n && n(i)
      }
    }),
    t.reg("geolocation",
    function(e) {
      return {
        "getCurrentPosition": function(t, n) {
          t = t || {},
          t.timeout = t.timeout || 1e3,
          navigator.geolocation && navigator.geolocation.getCurrentPosition ? navigator.geolocation.getCurrentPosition(function(e) {
            n(e && e.coords ? e: {
              "errorCode": 3,
              "errorMessage": "\u83b7\u53d6gps\u9519\u8bef"
            })
          },
          function(e) {
            n({
        ...
        "watchPosition": function(t, n) {
          return t = t || {},
          t.timeout = t.timeout || 1e3,
          navigator.geolocation && navigator.geolocation.watchPosition ? navigator.geolocation.watchPosition(function(e) {
            n(e && e.coords ? e: {
              "errorCode": 3,
              "errorMessage": "\u83b7\u53d6gps\u9519\u8bef"
            })
        ...
        "clearWatch": function(t, n) {
          var i = {};
          navigator.geolocation && navigator.geolocation.clearWatch ? navigator.geolocation.clearWatch(t) : e._noSuchApi(n),
          n && n(i)
        }
      }
    }),
      ...
      return {
        "watch": function(o, r) {
          ...
          if (e.DeviceMotionEvent) {
            ...
            a = n.set(c),
            e.addEventListener("devicemotion", c)
          } else t._noSuchApi(r);
          return a
        },
        "clearWatch": function(t, i) {
          var o = n.get(t);
          e.DeviceMotionEvent && o && (e.removeEventListener("devicemotion", o), n.remove(t)),
          i && i({})
        }
      }
    }),
      ...
      return {
        "watch": function(i, o) {
          ...
          return e.DeviceOrientationEvent && "ondeviceorientation" in e ? (r = n.set(function(e) {
            ...
            o(t)
          }), e.addEventListener("deviceorientation", n.get(r))) : t._noSuchApi(o),
          r
        },
        "clearWatch": function(t, i) {
          var o = n.get(t);
          e.DeviceOrientationEvent && o && (e.removeEventListener("deviceorientation", o), n.remove(t)),
          i && i({})
        }
      }
    }),
    ...
    function(e) {
      ...
      i = function(e, i) {
        e = e || {},
        e.sensitivity = e.sensitivity || 20,
        e.frequency = e.frequency || 150,
        e.callbackDelay = e.callbackDelay || 3e3;
        var r, a, c = {},
        u = t.set(c),
        s = function() {
          r || (r = a),
          Math.abs(a.x - r.x + a.y - r.y + a.z - r.z) > e.sensitivity ? (r = null, c.timeoutId = setTimeout(s, e.callbackDelay), i && i({})) : c.timeoutId = setTimeout(s, e.frequency)
        },
        d = !1;
        return c.motionWatchId = n.watch(e,
        function(t) {
      ...
      o = function(e, i) {
        var o = t.get(e);
        o && (n.clearWatch(o.motionWatchId), clearTimeout(o.timeoutId), t.remove(e)),
        i && i({})
      };
      return {
        "watch": i,
    ...
    t.reg("autoPushWindow",
    function() {
      var n = !1,
      i = !1,
      o = t.isWeb && t.isIOS && /safari/i.test(t.ua),
      r = function(e, t) {
      ...
      c = function(n) {
        ...
        if (e._ALI_NATIVE_AUTO_PUSH_WINDOW && (c.nativeOpen = !0), o && "_blank" === o.getAttribute("target") && o.getAttribute("href") && !n._triggered) {
          n.preventDefault();
          var u = o.href;
          return a(u) ? (i || (i = !0, t.pushWindow(u,
          function(e) {
      ...
      return e._ALI_HYBRID_AUTO_PUSH_WINDOW_VUE && t.callAfterReady("autoPushWindow.open", !0),
      e._ALI_HYBRID_AUTO_PUSH_WINDOW && t.callAfterReady("autoPushWindow.open"),
      {
        "open": function(e) {
          if ((!t.isWeb || o || e) && !n) {
    ...
    function() {
      ...
      for (var n in e) {
        var i = e[n];
        if (i.detect(t.ua)) return "tmall2" === n && (t.isTmall = !0),
        t["is" + n.slice(0, 1).toUpperCase() + n.slice(1)] = !0,
        t.isWeb = !1,
        void(t.cfgres = i.res)
      }
    } (),
    ...
    function(t) {
      ...
      r = o.getElementsByTagName("base")[0],
      a = function(e, t, a) {
        ...
        "onload" in c ? (c.onload = u, c.onerror = function() {
          u(!0)
        }) : c.onreadystatechange = function() { / loaded | complete / .test(c.readyState) && u()
        },
        c.src = e,
        n = c,
        r ? o.insertBefore(c, r) : o.appendChild(c),
        n = null
      },
      c = function(e, t) {
      ...
      u = function() {
        t._isReady = !0,
        t.event.trigger("ready"),
        t.event.remove("ready")
      },
      s = function() {
        t.event.trigger("init"),
        t.event.remove("init"),
        t.event.trigger("inited"),
        t.event.remove("inited"),
        t._isInit = !0,
        t._ready ? t._ready(u) : u()
      },
      d = function() {
    ...
    t.event.trigger("start"),
    t.event.remove("start"),
    e.KISSY && KISSY.add ? (KISSY.add("mui/hybrid/index",
    function() {
      return t
    }), KISSY.add("@ali/mui-hybrid/index",
    function() {
    ...
    function() {
      var n = (t.env.aliapp.name || "web") + "_" + t.env.os.name,
      i = Math.random() > .98,
      o = function(t) {
        var n = function() {
          e.setTimeout(t, 10)
      ...
      t._regLog = function(r) {
        "callWindVane" !== r && "regProxy" !== r && t.callAfterReady("regProxy", r,
        function(t) {
          r = r.replace(/\./g, "_");
          var a = "api=" + r + "&platform=" + n;
          return i && o(e.goldlog ?
          function() {
            goldlog && goldlog.record("/alihybrid.hybrid.callpercent", "EXP", a, "H1485189594")
          }: function() { (new Image).src = "//gm.mmstat.com/alihybrid.hybrid.callpercent?" + a + "&t=" + +new Date
          }),
          t
        })
      };
    ...
    function(e, t) {
      ...
      var W = {
        ...
        "fireEvent": function(e, t, n) {
          ...
          i.initEvent(e, !1, !0),
          i.param = E.parseData(t || E.getData(n)),
          a.dispatchEvent(i)
        },
        "getParam": function(e) {
          return E.getParam(e)
      ...
      E = {
        ...
        "setData": function() {
          this.chunks[P + sid] = this.chunks[P + sid] || [],
          this.chunks[P + sid].push(chunk)
        },
        "getData": function(e) {
        ...
        "unregisterCall": function(e) {
          var t = {};
          return this.calls[e] && (t = this.calls[e], delete this.calls[e]),
          t
        },
        "useIframe": function(e, t) {
          var n = g + e,
          i = v.pop();
          i || (i = a.createElement("iframe"), i.setAttribute("frameborder", "0"), i.style.cssText = "width:0;height:0;border:0;display:none;"),
          i.setAttribute("id", n),
        ...
        "onComplete": function(e, t, n) {
          ...
          t = this.parseData(t);
          var u = t.ret;
          "string" == typeof u && (t = t.value || t, t.ret || (t.ret = [u])),
          "success" === n ? (r && r(t), s && s.resolve(t)) : "failure" === n && (a && a(t), s && s.reject(t)),
          l ? (this.retrieveIframe(e), this.params[_ + e] && delete this.params[_ + e]) : c && this.chunks[P + e] && delete this.chunks[P + e]
        }
      };
      for (var T in W) d.call(h, T) || (h[T] = W[T])
    } (window, window.lib || (window.lib = {})),
    n.exports = window.lib.windvane
  });
  define("mui/mtop/index", ["mui/mtb-windvane/", "mui/babel-polyfill/"],
  function(e, t, n) {
    "use strict";
    ...
    function(e, t) {
      ...
      function p(e) {
        ...
        function d(e) {
          ...
          o = n + 8,
          i = (o - o % 64) / 64, r = 16 * (i + 1), s = new Array(r - 1), a = 0, p = 0; n > p;) {
            t = (p - p % 4) / 4,
            a = p % 4 * 8,
      ...
      function l(e, t, n) {
        ...
        var i = "/";
        document.cookie = e + "=;path=" + i + ";domain=." + t + ";expires=" + o.toGMTString(),
        document.cookie = e + "=;path=" + i + ";domain=." + n + "." + t + ";expires=" + o.toGMTString()
      }
      function f() {
      ...
      function h(e) {
        ...
        "object" == o(this.params.data) && (this.params.data = JSON.stringify(this.params.data)),
      ...
      h.prototype.__processRequestType = function(n) {
        ...
        else if ("undefined" == typeof r.WindVaneRequest && "undefined" == typeof r.H5Request && (t.windvane && parseFloat(r.WindVaneVersion) >= 5.4 ? r.WindVaneRequest = !0 : r.H5Request = !0, w)) if (r.WindVaneRequest = r.H5Request = void 0, e.AlipayJSBridge) {
        ...
        return s.indexOf("youku") > -1 && r.mainDomain.indexOf("youku.com") < 0 && (r.WindVaneRequest = !1, r.H5Request = !0),
        r.mainDomain.indexOf("youku.com") > -1 && s.indexOf("youku") < 0 && (r.WindVaneRequest = !1, r.H5Request = !0),
        n ? n().then(function() {
          var e = r.retJson.ret;
          if (e instanceof Array && (e = e.join(",")), r.WindVaneRequest === !0 && w && r.retJson.error || !e || e.indexOf("PARAM_PARSE_ERROR") > -1 || e.indexOf("HY_FAILED") > -1 || e.indexOf("HY_NO_HANDLER") > -1 || e.indexOf("HY_CLOSED") > -1 || e.indexOf("HY_EXCEPTION") > -1 || e.indexOf("HY_NO_PERMISSION") > -1) {
            if (!w || !(isNaN(r.retJson.error) || e.indexOf("FAIL_SYS_ACCESS_DENIED") > -1)) return w && u(i.data) && (i.data = JSON.stringify(i.data)),
            _.H5Request = !0,
            o.__sequence([o.__processRequestType, o.__processToken, o.__processRequestUrl, o.middlewares, o.__processRequest]);
      ...
      h.prototype.__getTokenFromAlipay = function() {
        ...
        return o.useAlipayJSBridge === !0 && !i && w && e.AlipayJSBridge && e.AlipayJSBridge.call ? e.AlipayJSBridge.call("getMtopToken",
        function(e) {
          e && e.token && (o.token = e.token),
          t.resolve()
        },
        function() {
          t.resolve()
      ...
      h.prototype.__getTokenFromCookie = function() {
        var e = this.options;
        return e.CDR && d(O) ? e.token = d(O).split(";")[0] : e.token = e.token || d(b),
      ...
      h.prototype.__processToken = function(e) {
        ...
        n.WindVaneRequest !== !0 ? v.then(function() {
          ...
          if (o instanceof Array && (o = o.join(",")), o.indexOf("TOKEN_EMPTY") > -1 || n.CDR === !0 && o.indexOf("ILLEGAL_ACCESS") > -1 || o.indexOf("TOKEN_EXOIRED") > -1) {
            ...
            n.maxRetryTimes > 0 && (l(O, n.pageDomain, "*"), l(b, n.mainDomain, n.subDomain), l(T, n.mainDomain, n.subDomain)),
            e.retType = R.TOKEN_EXPIRED
          }
        }) : void e()
      },
      ...
      h.prototype.__requestJSONP = function(e) {
        ...
        return d.src = a.path + "?" + s(a.querystring) + "&" + s(a.postdata),
        d.async = !0,
        d.onerror = function() {
          t("ABORT"),
      ...
      h.prototype.__requestJSON = function(t) {
        ...
        u);
        a.CDR && d(O) && (a.querystring.c = decodeURIComponent(d(O))),
      ...
      h.prototype.__requestWindVane = function(e) {
        ...
        "undefined" != typeof r.valueType && ("original" === r.valueType ? d = "originaljson": "string" === r.valueType && (d = "")),
        s.useJsonpResultType === !0 && (d = "");
        var l, f, m = "https" === location.protocol ? 1 : 0,
        h = r.isSec || 0,
        g = r.sessionOption || "AutoLoginOnly",
        v = r.ecode || 0;
        return f = "undefined" != typeof r.timer ? parseInt(r.timer) : "undefined" != typeof r.timeout ? parseInt(r.timeout) : 2e4,
        l = 2 * f,
        r.needLogin === !0 && "undefined" == typeof r.sessionOption && (g = "AutoLoginAndManualLogin"),
        "undefined" != typeof r.secType && "undefined" == typeof r.isSec && (h = r.secType),
      ...
      h.prototype.__requestAlipay = function(t) {
        ...
        return u(r.data) || (r.data = JSON.parse(r.data)),
        a.data = r.data,
        r.ttid && (a.ttid = r.ttid),
        (s.getJSON || s.postJSON || s.getOriginalJSONP) && (a.type = "originaljson"),
        "undefined" != typeof r.valueType && ("original" === r.valueType ? a.type = "originaljson": "string" === r.valueType && delete a.type),
        s.useJsonpResultType === !0 && delete a.type,
        e.AlipayJSBridge.call("mtop", a, o),
        i.promise
      },
      h.prototype.__processRequest = function(e, t) {
        ...
        return v.then(function() {
          ...
          o.indexOf("SUCCESS") > -1 ? t.retType = R.SUCCESS: t.retType = R.ERROR,
          e.retJson = t
        })
      },
      ...
      h.prototype.request = function(n) {
        ...
        var s = g.resolve([A, x]).then(function(e) {
          ...
          o.options.failureCallback ? void o.options.failureCallback(t) : g.reject(t)
        });
        return this.__processRequestType(),
        o.options.H5Request && (o.constructor.__firstProcessor || (o.constructor.__firstProcessor = s), A = function e(t) {
          o.constructor.__firstProcessor.then(t)["catch"](t)
        }),
        ("get" === this.params.type && "json" === this.params.dataType || "post" === this.params.type) && (n.pageDomain = n.pageDomain || a(e.location.hostname), n.mainDomain !== n.pageDomain && (n.maxRetryTimes = 4, n.CDR = !0)),
        s
      },
      t.mtop = function(e) {
        return new h(e)
    ...
    function(e, t) {
      ...
      function i(t, o) {
        ...
        c.style.cssText = ["width:100%", "height:52px", "background:#EEE", "line-height:52px", "text-align:left", "box-sizing:border-box", "padding-left:20px", "position:absolute", "left:0", "top:0", "font-size:16px", "font-weight:bold", "color:#333"].join(";"),
        c.innerText = t;
        ...
        p > 800 && (c.style.cssText = ["width:370px", "height:52px", "background:#EEE", "line-height:52px", "text-align:left", "box-sizing:border-box", "padding-left:20px", "position:absolute", "left:" + (p / 2 - 185) + "px", "top:40px", "font-size:16px", "font-weight:bold", "color:#333"].join(";"), l.style.cssText = ["position:absolute", "top:92px", "left:" + (p / 2 - 185) + "px", "width:370px", "height:480px", "border:0", "background:#FFF", "overflow:hidden"].join(";")),
        c.appendChild(d),
        s.appendChild(c),
        s.appendChild(l),
            ...
            return new p(function(o, a) {
              ...
              function c(t) {
                ...
                if (i && "child" === i.type) {
                  ...
                  var d;
                  try {
                    d = JSON.parse(decodeURIComponent(i.content)),
    ...
    n.exports = window.lib["mtop"]; (function(e, t) {
      function n(e) {
        var t = this.options;
        var n = false;
        var o;
  ...
  KISSY.config({
    ...
    "modules": {
      "detail-m/app": {
        "requires": ["mui/slider-m/index", "mui/zepto/zepto", "mui/zepto/touch", "mui/zepto/event", "mui/xtemplate/index", "mui/mtop/index", "mui/fetch/jsonp", "mui/fetch/tool", "mui/crossimage/index", "detail-m/widgets/loading/index", "mui/datalazyload/index", "mui/custom-event/index"]
      },
      "detail-m/model/bundleItem": {
        "requires": ["./model"]
      },
      "detail-m/model/index": {
        "requires": ["./model", "./bundleItem", "mui/fetch/jsonp", "mui/fetch/tool", "mui/custom-event/index"]
      },
      "detail-m/mods/action-bar/banner": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/action-bar/fav": {
        "requires": ["mui/zepto/zepto", "./index.xtpl", "detail-m/widgets/server/index"]
      },
      "detail-m/mods/action-bar/index": {
        "requires": ["mui/zepto/zepto", "detail-m/mods/trade/index", "detail-m/mods/action-bar/banner", "detail-m/mods/action-bar/fav", "detail-m/mods/action-bar/switch", "./mods"]
      },
      "detail-m/mods/action-bar/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/action-bar/mods": {
        "requires": ["mui/zepto/zepto"]
      },
      "detail-m/mods/action-bar/switch": {
        "requires": ["mui/zepto/zepto"]
      },
      "detail-m/mods/content/index": {
        "requires": ["mui/zepto/zepto", "./part.xtpl"]
      },
      "detail-m/mods/content/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/content/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/descCustom/miao2.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/descCustom/simple.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/head/index": {
        "requires": ["mui/zepto/zepto"]
      },
      "detail-m/mods/head/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-activity/index": {
        "requires": ["mui/zepto/zepto"]
      },
      "detail-m/mods/module-activity/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-adds-hk/index": {
        "requires": ["mui/zepto/zepto", "mui/crossimage/index", "mui/datalazyload/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-adds-hk/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-adds-hk/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-adds/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-adds/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-adds/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-advantage/cover": {
        "requires": ["detail-m/widgets/cover/index", "mui/zepto/zepto", "./cover.xtpl", "./cover.css"]
      },
      "detail-m/mods/module-advantage/cover.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-advantage/index": {
        "requires": ["mui/zepto/zepto", "mui/crossimage/index", "mui/datalazyload/index", "./part.xtpl"]
      },
      "detail-m/mods/module-advantage/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-advantage/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-app-download-popup/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/touch", "detail-m/widgets/server/index"]
      },
      "detail-m/mods/module-app-download-popup/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-askall/index": {
        "requires": ["mui/zepto/zepto"]
      },
      "detail-m/mods/module-askall/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-atmosphere/index": {
        "requires": ["mui/zepto/zepto", "mui/crossimage/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-atmosphere/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-atmosphere/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-bottombar-qiang/index": {
        "requires": ["detail-m/widgets/jbc/utils", "detail-m/widgets/jbc/sku", "detail-m/widgets/toast/index", "detail-m/mods/trade/index", "mui/zepto/zepto", "./part.xtpl", "./index.css"]
      },
      "detail-m/mods/module-bottombar-qiang/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-bottombar-qiang/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-bottombar/index": {
        "requires": ["../../libs/jbc", "../../libs/utils", "../../libs/event", "../../libs/sku", "detail-m/widgets/jbc/storage", "./remind", "detail-m/widgets/toast/index", "./index.css", "./index.tpl"]
      },
      "detail-m/mods/module-bottombar/remind": {
        "requires": ["../../libs/utils"]
      },
      "detail-m/mods/module-brandshow/index": {
        "requires": ["mui/zepto/zepto", "./part.xtpl", "./index.css"]
      },
      "detail-m/mods/module-brandshow/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-brandshow/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-certification/index": {
        "requires": ["mui/zepto/zepto", "mui/crossimage/index"]
      },
      "detail-m/mods/module-certification/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-coupon-ju/index": {
        "requires": ["mui/zepto/zepto", "detail-m/widgets/toast/index", "mui/xtemplate/index", "./index.css"]
      },
      "detail-m/mods/module-coupon-ju/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-coupon-link/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/touch", "./part.xtpl", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-coupon-link/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-coupon-link/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-coupon/cover": {
        "requires": ["detail-m/widgets/cover/index", "mui/zepto/zepto", "./cover.xtpl", "detail-m/widgets/toast/index", "./cover.css"]
      },
      "detail-m/mods/module-coupon/cover.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-coupon/index": {
        "requires": ["mui/zepto/zepto", "mui/crossimage/index", "mui/datalazyload/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-coupon/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-coupon/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-desc/desc": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/zepto/touch", "./index.xtpl", "detail-m/widgets/server/index", "mui/custom-event/index", "mui/crossimage/index", "detail-m/widgets/photoSwipe/index", "mui/datalazyload/index", "./mods", "mui/mdv/index", "mui/mdv/zebra", "./index.css"]
      },
      "detail-m/mods/module-desc/index": {
        "requires": ["mui/datalazyload/index", "mui/zepto/zepto"]
      },
      "detail-m/mods/module-desc/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-desc/judesc": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/zepto/touch", "./index.xtpl", "detail-m/widgets/server/index", "mui/custom-event/index", "mui/crossimage/index", "detail-m/widgets/photoSwipe/index", "mui/datalazyload/index", "./mods", "./index.css"]
      },
      "detail-m/mods/module-desc/mods": {
        "requires": ["mui/zepto/zepto"]
      },
      "detail-m/mods/module-focus/index": {
        "requires": ["mui/zepto/zepto", "mui/crossimage/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-focus/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-focus/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-from/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-from/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-from/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-header/index": {
        "requires": ["mui/zepto/zepto", "./part.xtpl"]
      },
      "detail-m/mods/module-header/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-header/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-hko2o/index": {
        "requires": ["mui/zepto/zepto"]
      },
      "detail-m/mods/module-hko2o/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-hko2o/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-jhs/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-jhs/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-jhs/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-juduoduo/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index", "mui/datalazyload/index", "mui/crossimage/index"]
      },
      "detail-m/mods/module-juduoduo/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-mlh/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-mlh/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-mlh/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-pintuan/index": {
        "requires": ["mui/zepto/zepto", "./part.xtpl", "./index.css"]
      },
      "detail-m/mods/module-pintuan/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-pintuan/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-preview/index": {
        "requires": ["mui/slider-m/index", "mui/zepto/zepto", "mui/crossimage/index", "mui/zepto/touch", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-preview/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-preview/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-price/index": {
        "requires": ["mui/zepto/zepto", "./part.xtpl", "detail-m/mods/module-price/promotion.js", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-price/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-price/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-price/promotion": {
        "requires": ["mui/zepto/zepto", "mui/crossimage/index"]
      },
      "detail-m/mods/module-prom-country/index": {
        "requires": ["./index.css", "mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-prom-country/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-prom-country/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-prom/cover": {
        "requires": ["detail-m/widgets/cover/index", "mui/zepto/zepto", "./cover.xtpl", "detail-m/widgets/toast/index", "./cover.css"]
      },
      "detail-m/mods/module-prom/cover.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-prom/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-prom/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-prom/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-props/cover": {
        "requires": ["detail-m/widgets/cover/index", "mui/zepto/zepto", "./cover.xtpl", "detail-m/widgets/toast/index", "./cover.css"]
      },
      "detail-m/mods/module-props/cover.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-props/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/touch"]
      },
      "detail-m/mods/module-props/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-again/index": {
        "requires": ["mui/slider-m/index", "mui/zepto/zepto", "mui/zepto/touch", "mui/datalazyload/index", "mui/crossimage/index", "mui/fetch/tool", "mui/fetch/jsonp", "mui/chaoshi-ald/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-again/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-again/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-down/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/touch", "mui/datalazyload/index", "mui/crossimage/index", "mui/fetch/jsonp", "mui/fetch/tool", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-down/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-down/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-hot/index": {
        "requires": ["mui/fetch/jsonp", "mui/zepto/zepto", "mui/zepto/touch", "mui/datalazyload/index", "mui/crossimage/index", "mui/fetch/tool", "mui/dlp/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-hot/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-hot/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-ju/index": {
        "requires": ["mui/datalazyload/index", "mui/crossimage/index", "mui/zepto/zepto", "mui/fetch/jsonp", "mui/fetch/tool", "mui/xtemplate/index", "../../widgets/jbc/h5data", "./part.xtpl", "./index.css"]
      },
      "detail-m/mods/module-recommend-ju/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-ju/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-see/index": {
        "requires": ["mui/slider-m/index", "mui/zepto/zepto", "mui/zepto/touch", "./part.xtpl", "mui/datalazyload/index", "mui/crossimage/index", "mui/fetch/tool", "mui/fetch/jsonp", "mui/chaoshi-ald/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-see/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-see/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-today/index": {
        "requires": ["mui/fetch/jsonp", "mui/zepto/zepto", "mui/zepto/touch", "mui/datalazyload/index", "mui/crossimage/index", "mui/dlp/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-today/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend-today/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend/index": {
        "requires": ["mui/slider-m/index", "mui/zepto/zepto", "mui/zepto/touch", "mui/datalazyload/index", "mui/crossimage/index", "mui/dlp/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-recommend/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-related/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/touch", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-related/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-related/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-review/index": {
        "requires": ["mui/datalazyload/index", "mui/zepto/zepto", "mui/crossimage/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-review/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-review/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-selltext/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index", "./index.css"]
      },
      "detail-m/mods/module-selltext/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-shop/cover": {
        "requires": ["detail-m/widgets/cover/index", "mui/zepto/zepto", "./cover.xtpl", "detail-m/widgets/toast/index", "detail-m/widgets/server/index", "./cover.css"]
      },
      "detail-m/mods/module-shop/cover.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-shop/index": {
        "requires": ["mui/zepto/zepto", "mui/crossimage/index", "mui/datalazyload/index", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-shop/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-shop/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-sku/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/touch"]
      },
      "detail-m/mods/module-sku/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-sku/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-smartjump/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/touch"]
      },
      "detail-m/mods/module-smartjump/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-smartjump/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-statusbar/index": {
        "requires": ["mui/zepto/zepto", "../../widgets/jbc/utils", "../../widgets/jbc/countdown", "mui/custom-event/index", "mui/xtemplate/index", "./part.xtpl", "./index.css"]
      },
      "detail-m/mods/module-statusbar/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-statusbar/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-store-banner/index": {
        "requires": ["mui/zepto/zepto", "./part.xtpl", "mui/crossimage/index", "./index.css"]
      },
      "detail-m/mods/module-store-banner/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-store-banner/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-store-detail/index": {
        "requires": ["mui/zepto/zepto", "./part.xtpl", "./index.css"]
      },
      "detail-m/mods/module-store-detail/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-store-detail/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-store/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-store/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-store/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-tariff/cover": {
        "requires": ["detail-m/widgets/cover/index", "mui/zepto/zepto", "./cover.xtpl", "./cover.css"]
      },
      "detail-m/mods/module-tariff/cover.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-tariff/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-tariff/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-tariff/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-text/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-text/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-text/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-title/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/module-title/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/module-title/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/address": {
        "requires": ["mui/zepto/zepto", "./address.xtpl"]
      },
      "detail-m/mods/sku/address.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/bundle-item-cover": {
        "requires": ["detail-m/widgets/cover/index", "mui/zepto/zepto", "./bundle-item-cover.xtpl", "./bundle-item-summary.xtpl", "./bundle-item-skuList"]
      },
      "detail-m/mods/sku/bundle-item-cover.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/bundle-item-skuList": {
        "requires": ["mui/zepto/zepto", "./bundle-item-skuList.xtpl"]
      },
      "detail-m/mods/sku/bundle-item-skuList.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/bundle-item-summary.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/bundle-list-cover": {
        "requires": ["detail-m/widgets/cover/index", "mui/zepto/zepto", "./bundle-list-cover.xtpl", "./bundle-list-cover.css"]
      },
      "detail-m/mods/sku/bundle-list-cover.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/bundles": {
        "requires": ["mui/zepto/zepto", "./bundles.xtpl", "./bundle-item-skuList"]
      },
      "detail-m/mods/sku/bundles.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/buy-type": {
        "requires": ["mui/zepto/zepto", "./buy-type.xtpl"]
      },
      "detail-m/mods/sku/buy-type.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/index": {
        "requires": ["detail-m/widgets/cover/index", "mui/zepto/zepto", "./index.xtpl", "./summary.xtpl", "./skuList", "./bundles", "./address", "./buy-type", "./sku-type", "./pickup", "./number", "./service", "./mods", "./installment", "detail-m/widgets/photoSwipe/index", "detail-m/mods/trade/index", "mui/crossimage/index", "./index.css"]
      },
      "detail-m/mods/sku/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/installment": {
        "requires": ["mui/zepto/zepto", "./installment.xtpl", "../../widgets/snabbdom/tovnode", "../../widgets/snabbdom/index", "../../widgets/snabbdom/modules/class", "../../widgets/snabbdom/modules/props", "../../widgets/snabbdom/modules/style", "../../widgets/snabbdom/modules/eventlisteners", "../../widgets/snabbdom/modules/attributes", "../../widgets/snabbdom/modules/dataset"]
      },
      "detail-m/mods/sku/installment.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/mods": {
        "requires": ["mui/zepto/zepto"]
      },
      "detail-m/mods/sku/number": {
        "requires": ["mui/zepto/zepto", "./number.xtpl"]
      },
      "detail-m/mods/sku/number.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/pickup": {
        "requires": ["mui/zepto/zepto", "./pickup.xtpl"]
      },
      "detail-m/mods/sku/pickup.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/service": {
        "requires": ["mui/zepto/zepto", "./service.xtpl"]
      },
      "detail-m/mods/sku/service.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/sku-type": {
        "requires": ["mui/zepto/zepto", "./sku-type.xtpl"]
      },
      "detail-m/mods/sku/sku-type.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/skuList": {
        "requires": ["mui/zepto/zepto", "./skuList.xtpl"]
      },
      "detail-m/mods/sku/skuList.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/sku/summary.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/mods/trade/index": {
        "requires": ["mui/zepto/zepto", "mui/xtemplate/index"]
      },
      "detail-m/mods/trade/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/pages/miniBuy.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/widgets/address/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/cover/sliding-menu/index", "mui/xtemplate/index", "mui/custom-event/index", "detail-m/widgets/address/queryAreaInfo", "mui/fetch/jsonp", "detail-m/widgets/address/index.css"]
      },
      "detail-m/widgets/address/queryAreaInfo": {
        "requires": ["mui/zepto/zepto", "mui/custom-event/index"]
      },
      "detail-m/widgets/atp/index": {
        "requires": ["../md5/index", "mui/cookie/index", "mui/zepto/zepto", "mui/zepto/event", "../tool", "mui/datalazyload/index"]
      },
      "detail-m/widgets/countdown/index": {
        "requires": ["./index.css", "mui/zepto/zepto", "mui/mtop/index"]
      },
      "detail-m/widgets/cover/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/touch", "./index.css"]
      },
      "detail-m/widgets/imageviewer/index": {
        "requires": ["mui/slider-m/index", "mui/zepto/zepto", "mui/zepto/event", "./index.xtpl", "mui/zepto/touch", "./index.css"]
      },
      "detail-m/widgets/imageviewer/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/widgets/jbc/sku": {
        "requires": ["./utils", "detail-m/widgets/toast/index", "mui/zepto/zepto", "./sku.css"]
      },
      "detail-m/widgets/jbc/utils": {
        "requires": ["mui/zepto/zepto"]
      },
      "detail-m/widgets/loading/index": {
        "requires": ["mui/zepto/zepto"]
      },
      "detail-m/widgets/navigator/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event"]
      },
      "detail-m/widgets/photoSwipe/index": {
        "requires": ["mui/zepto/zepto", "mui/crossimage/index", "./photoSwipe", "./ui", "./part.xtpl", "detail-m/widgets/photoSwipe/index.css"]
      },
      "detail-m/widgets/photoSwipe/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/widgets/server/index": {
        "requires": ["mui/zepto/zepto", "mui/custom-event/index", "mui/fetch/jsonp"]
      },
      "detail-m/widgets/snabbdom/h": {
        "requires": ["./vnode", "./is"]
      },
      "detail-m/widgets/snabbdom/index": {
        "requires": ["./h", "./thunk", "./vnode", "./is", "./htmldomapi"]
      },
      "detail-m/widgets/snabbdom/thunk": {
        "requires": ["./h"]
      },
      "detail-m/widgets/snabbdom/tovnode": {
        "requires": ["./vnode", "./htmldomapi"]
      },
      "detail-m/widgets/toast/index": {
        "requires": ["mui/zepto/zepto", "./index.css"]
      },
      "detail-m/widgets/uaddress/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/cover/sliding-menu/index", "./part.xtpl", "./index.xtpl", "mui/custom-event/index", "detail-m/widgets/toast/index", "mui/fetch/jsonp", "detail-m/widgets/uaddress/index.css"]
      },
      "detail-m/widgets/uaddress/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-m/widgets/uaddress/part.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "detail-mods/tb-banner/index": {
        "requires": ["./index.css", "mui/zepto/zepto", "./part.xtpl"]
      },
      "detail-mods/tb-banner/index.xtpl": {
        "requires": ["mui/xtemplate/runtime", "tb-banner/index.css"]
      },
      "detail-mods/tb-banner/jump": {
        "requires": ["./index.css", "mui/zepto/touch", "mui/fetch/jsonp", "mui/crossimage/"]
      },
      "detail-mods/tb-banner/part.xtpl": {
        "requires": ["mui/xtemplate/runtime", "tb-banner/part.css"]
      },
      "hybrid/plugin/ar": {
        "requires": ["mui/hybrid/index"]
      },
      "hybrid/plugin/blockNativeBack": {
        "requires": ["mui/hybrid/index"]
      },
      "hybrid/plugin/blow": {
        "requires": ["mui/hybrid/index"]
      },
      "hybrid/plugin/nativeRequest": {
        "requires": ["mui/hybrid/index"]
      },
      "hybrid/plugin/pageVisibility": {
        "requires": ["mui/hybrid/index"]
      },
      "hybrid/plugin/plugin": {
        "requires": ["mui/hybrid/index"]
      },
      "hybrid/plugin/seed": {
        "requires": ["mui/hybrid/index"]
      ...
      "mui/app-download-popup/env": {
        "requires": ["mui/tengine-detector/index", "mui/app-download-popup/util"]
      },
      "mui/app-download-popup/index": {
        "requires": ["mui/app-download-popup/env", "mui/app-download-popup/util", "mui/smart-jump/index", "mui/fetch/jsonp", "mui/zepto/zepto", "mui/datalazyload/", "mui/crossimage/", "mui/app-download-popup/index.css"]
      },
      "mui/chaoshi-ald/index": {
        "requires": ["mui/mtop/index", "mui/custom-event/index", "mui/chaoshi-app/site-info"]
      },
      "mui/chaoshi-app/city-code": {
        "requires": ["mui/babel-polyfill/index", "mui/cookie/index"]
      },
      "mui/chaoshi-app/oc": {
        "requires": ["mui/mtop/index", "./site-info"]
      },
      "mui/chaoshi-app/site-info": {
        "requires": ["mui/babel-polyfill/index", "mui/cookie/index"]
      },
      "mui/chaoshi-app/user-info": {
        "requires": ["mui/babel-polyfill/index", "mui/mtop/index"]
      },
      "mui/cover/index": {
        "requires": ["mui/zepto/zepto", "mui/custom-event/index", "mui/cover/index.css"]
      },
      "mui/cover/sliding-menu/index": {
        "requires": ["mui/zepto/event", "mui/cover/index", "mui/cover/sliding-menu/index.css"]
      },
      "mui/crossimage/index": {
        "requires": ["mui/babel-polyfill/index", "mui/zepto/zepto"]
      },
      "mui/datalazylist/dllView": {
        "requires": ["mui/zepto/zepto", "mui/datalazylist/index", "mui/xtemplate/index"]
      },
      "mui/datalazylist/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/datalazylist/render/node", "mui/datalazylist/render/multinode", "mui/datalazylist/loader/page", "mui/datalazylist/loader/static"]
      },
      "mui/datalazylist/render/multinode": {
        "requires": ["mui/datalazylist/render/node"]
      },
      "mui/datalazylist/render/node": {
        "requires": ["mui/zepto/zepto"]
      },
      "mui/datalazyload/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event"]
      },
      "mui/desc-mods/custommodule/index": {
        "requires": ["mui/desc-mods/custommodule/index.css", "mui/zepto/zepto", "mui/datalazyload/index", "mui/crossimage/index"]
      },
      "mui/desc-mods/custommodule/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/matchrecommend/index": {
        "requires": ["mui/zepto/zepto", "mui/datalazyload/index", "mui/crossimage/index"]
      },
      "mui/desc-mods/matchrecommend/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/packlist/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/zepto/touch"]
      },
      "mui/desc-mods/packlist/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/servicepresent/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/shopactivity/index": {
        "requires": ["mui/zepto/zepto", "mui/datalazyload/index", "mui/crossimage/index", "./list.xtpl"]
      },
      "mui/desc-mods/shopactivity/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/shopactivity/list.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/shopcoupon/coupon.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/shopcoupon/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/zepto/touch", "mui/datalazyload/index", "mui/desc-mods/shopcoupon/coupon.xtpl"]
      },
      "mui/desc-mods/shopcoupon/index-pc.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/shopcoupon/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/shopcustomtext/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/shoprecommend/index": {
        "requires": ["mui/zepto/zepto", "mui/datalazyload/index", "./list.xtpl"]
      },
      "mui/desc-mods/shoprecommend/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/shoprecommend/list.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/shoptext/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/sizerecommend/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/datalazyload/index", "mui/crossimage/index", "mui/iscroll-lite/index"]
      },
      "mui/desc-mods/sizerecommend/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/standardItemProps/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/datalazyload/index", "mui/crossimage/index"]
      },
      "mui/desc-mods/standardItemProps/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/desc-mods/wpimagetext/index": {
        "requires": ["mui/desc-mods/wpimagetext/index.css", "mui/zepto/zepto", "mui/datalazyload/index", "mui/crossimage/index"]
      },
      "mui/desc-mods/wpimagetext/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/dialog/index": {
        "requires": ["./index.css", "mui/zepto/touch"]
      },
      "mui/fetch/fetch": {
        "requires": ["mui/babel-polyfill/index"]
      },
      "mui/fetch/iframePostForm": {
        "requires": ["mui/zepto/zepto"]
      },
      "mui/fetch/jsonp": {
        "requires": ["mui/fetch/fetch", "mui/fetch/tool"]
      },
      "mui/h2-toast/index": {
        "requires": ["mui/h2-toast/index.css"]
      },
      "mui/mdv/index": {
        "requires": ["mui/mdv/util/getScript", "mui/mdv/util/guid", "mui/zepto/zepto"]
      },
      "mui/mdv/zebra": {
        "requires": ["mui/mdv/index"]
      },
      "mui/mtop/index": {
        "requires": ["mui/mtb-windvane/", "mui/babel-polyfill/"]
      },
      "mui/mtop/storage-middleware": {
        "requires": ["mui/babel-polyfill/"]
      },
      "mui/popbox/index": {
        "requires": ["mui/custom-event/index", "mui/zepto/event", "mui/popbox/index.css", "mui/babel-polyfill/"]
      },
      "mui/popbox/index-pc": {
        "requires": ["mui/custom-event/index", "mui/zepto/event", "mui/popbox/index-pc.css", "mui/babel-polyfill/"]
      },
      "mui/prompt/indicator/index": {
        "requires": ["mui/zepto/zepto", "mui/prompt/css/loading.css", "mui/prompt/css/indicator/index.css"]
      },
      "mui/prompt/loading": {
        "requires": ["mui/zepto/zepto", "mui/custom-event/index"]
      },
      ...
      "mui/review-m/index": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/zepto/touch", "mui/review-m/index.css", "mui/dlp/index", "mui/datalazylist/", "mui/crossimage/", "mui/review-m/widgets/gallery.js", "mui/review-m/widgets/utils.js", "mui/review-m/tpl/main.xtpl", "mui/review-m/tpl/list.xtpl", "mui/review-m/tpl/tags.xtpl"]
      },
      "mui/review-m/index.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/review-m/instance/detail": {
        "requires": ["mui/zepto/zepto", "mui/zepto/event", "mui/zepto/touch", "mui/review-m/index.css", "mui/review-m/instance/detail.css", "mui/dlp/index", "mui/datalazylist/", "mui/crossimage/", "mui/review-m/widgets/utils.js", "mui/review-m/tpl/detail.xtpl", "mui/review-m/tpl/list.xtpl", "mui/review-m/tpl/tags.xtpl"]
      },
      "mui/review-m/tpl/detail.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/review-m/tpl/list.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/review-m/tpl/main.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/review-m/tpl/tags.xtpl": {
        "requires": ["mui/xtemplate/index"]
      },
      "mui/review-m/widgets/gallery": {
        "requires": ["mui/review-m/widgets/gallery.css", "mui/zepto/zepto", "mui/zepto/event", "mui/zepto/touch", "mui/crossimage/", "mui/slider-m/index"]
      },
      "mui/slider-m/index": {
        "requires": ["mui/flipsnap/index", "mui/custom-event/index"]
      },
      "mui/smart-jump/index": {
        "requires": ["mui/smart-jump/index.css", "mui/zepto/touch", "mui/crossimage/", "./mods/util", "./mods/env", "./mods/action", "./mods/callApp", "./mods/loadConfig"]
      },
      "mui/smart-jump/index-copy": {
        "requires": ["mui/smart-jump/index.css", "mui/zepto/touch", "mui/fetch/jsonp", "mui/crossimage/", "./mods/util", "./mods/env", "./mods/action", "./mods/callApp", "./mods/loadConfig"]
      },
      "mui/smart-jump/index-native": {
        "requires": ["mui/weex-zebra-utils/index-native"]
      },
      "mui/smart-jump/mods/action": {
        "requires": ["./util", "./env"]
      },
      "mui/smart-jump/mods/callApp": {
        "requires": ["./util", "./env", "./download"]
      },
      "mui/smart-jump/mods/download": {
        "requires": ["./util"]
      },
      "mui/smart-jump/mods/env": {
        "requires": ["./util"]
      },
      "mui/smart-jump/mods/loadConfig": {
        "requires": ["mui/fetch/jsonp", "./action"]
      },
      "mui/smart-jump/mods/log": {
        "requires": ["./util"]
      },
      "mui/tengine-detector/index.xtpl": {
        "requires": ["mui/xtemplate/runtime"]
      },
      "mui/tinycart/auto": {
        "requires": ["mui/hybrid/index", "mui/zepto/touch", "./index"]
      },
      "mui/tinycart/index": {
        "requires": ["./index.css", "mui/hybrid/index", "hybrid/plugin/pageVisibility", "mui/zepto/zepto", "mui/custom-event/index", "./lib/model", "mui/prompt/indicator/index"]
      },
      "mui/tinycart/lib/animation": {
        "requires": ["mui/custom-event/index", "mui/zepto/zepto"]
      },
      "mui/tinycart/lib/model": {
        "requires": ["mui/mtb-windvane/index", "mui/custom-event/index", "mui/zepto/zepto", "mui/mtop/index"]
      },
      "mui/videox/index": {
        "requires": ["./lib/videox"]
      },
      ...
      "mui/xtemplate/compiler": {
        "requires": ["./runtime", "./compiler/tools", "./compiler/parser", "./compiler/ast"]
      },
      "mui/xtemplate/index": {
        "requires": ["./runtime", "./compiler"]
      },
      "mui/xtemplate/runtime": {
        "requires": ["./runtime/util", "./runtime/commands", "./runtime/scope", "./runtime/linked-buffer"]
      },
      "mui/xtemplate/runtime/commands": {
        "requires": ["./scope", "./util"]
      },
      "mui/xtemplate/runtime/linked-buffer": {
        "requires": ["./util"]
      },
      "mui/xtemplate/runtime/util": {
      ...
      "mui/zepto/fx_methods": {
        "requires": ["mui/zepto/zepto", "mui/zepto/fx"]
      },
      "mui/zepto/gesture": {
        "requires": ["mui/zepto/zepto"]
      },
    ...
    "packages": {
      "detail-m": {
        ...
        "path": "//g.alicdn.com/tm/detail-b/4.2.20/",
        "version": "4.2.20"
      },
      ...
      "mui/desc-mods": {
        ...
        "group": "tm",
        "ignorePackageNameInUri": !0,
        "path": "//g.alicdn.com/mui/desc-mods/4.0.15/",
        "version": "4.0.15"
      },
      "mui/dialog": {
        "debug": !0,
  ...
  function(t, e, n) {
    ...
    var r = function() {
      ...
      function p(t) {
        var e, n;
        return M[t] || (e = L.createElement(t), L.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), M[t] = n),
        M[t]
      }
      function d(t) {
        return "children" in t ? q.call(t.children) : N.map(t.childNodes,
        function(t) {
      ...
      G.fragment = function(t, e, n) {
        ...
        i || (t.replace && (t = t.replace(Z, "<$1></$2>")), e === E && (e = D.test(t) && RegExp.$1), e in X || (e = "*"), o = X[e], o.innerHTML = "" + t, i = N.each(q.call(o.childNodes),
        function() {
          o.removeChild(this)
        })),
        s(n) && (r = N(i), N.each(n,
      ...
      G.init = function(t, n) {
        var i;
        if (!t) return G.Z();
        if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && D.test(t)) i = G.fragment(t, RegExp.$1, n),
        t = null;
        else {
          ...
          t = null;
          else if (D.test(t)) i = G.fragment(t.trim(), RegExp.$1, n),
          t = null;
          else {
            if (n !== E) return N(n).find(t);
            i = G.qsa(L, t)
      ...
      N.map = function(t, e) {
        var n, i, r, o = [];
        if (u(t)) for (i = 0; i < t.length; i++) n = e(t[i], i),
        null != n && o.push(n);
      ...
      N.fn = {
        ...
        "ready": function(t) {
          return B.test(L.readyState) && L.body ? t(N) : L.addEventListener("DOMContentLoaded",
          function() {
            t(N)
          },
          !1),
        ...
        "filter": function(t) {
          return e(t) ? this.not(this.not(t)) : N(k.call(this,
          function(e) {
        ...
        "parents": function(t) {
          for (var e = [], n = this; n.length > 0;) n = N.map(n,
          function(t) {
        ...
        "toggle": function(t) {
          return this.each(function() {
            var e = N(this); (t === E ? "none" == e.css("display") : t) ? e.show() : e.hide()
          })
        },
        "prev": function(t) {
        ...
        "attr": function(t, e) {
          ...
          return "string" != typeof t || 1 in arguments ? this.each(function(n) {
            if (1 === this.nodeType) if (o(t)) for (T in t) b(this, T, t[T]);
        ...
        "offset": function(t) {
          ...
          if (!N.contains(L.documentElement, this[0])) return {
            "top": 0,
            "left": 0
          };
  ...
  define("detail-m/mods/head/index", ["mui/zepto/zepto"],
  function(e, t, i) {
    function n(e, t) {
    ...
    h = function() {
      ...
      },
      {
        ...
        "value": function(e, t) {
          ...
          n = void 0;
          i && (n = i.offset().top - (this.options.stickyTopHolder + this.$el.height())) !== t && (this._updateFloorOffsets(), r.$item = i, l = !0, r.scrollTo(0, n), setTimeout(function() {
            l = !1
          },
          10))
        }
      },
      {
        ...
        "value": function() {
          ...
          n = 0;
          for (var o in p) if (t - p[f - o - 1] + i >= -50) {
      ...
      },
      {
        ...
        "value": function(e, t) {
          ...
          var i = this,
          n = i.$navItems.eq(e),
          o = (n.attr("data-x"), i.options.activeCss);
      ...
      },
      {
        ...
        "value": function(e) {
          ...
          c === e || l || (i = p[e] - (t.options.stickyTopHolder + t.$el.height()), c = e, l = !0, t._updateNav(e, 1e3 * t.options.duration), t.options.beginCallback(e, n), t.scrollAnim(r, i, 1e3 * t.options.duration,
          function() {
      ...
      },
      {
        ...
        "value": function(e, t, i, n) {
          ...
          if (! (i < 0)) {
            ...
            u = r / i * 10;
            Math.abs(r) >= 1 ? (window.scrollTo(0, t), n()) : this.scrollToTimerCache = setTimeout(function() {
              isNaN(parseInt(u, 10)) ? n() : (window.scrollTo(0, a(window).scrollTop() + u), o.scrollAnim(e, t, i - 10, n))
            }.bind(this), 10)
          }
        }
      }]),
    ...
    x = function() {
      ...
      return o(t, [{
        ...
        "value": function() {
          ...
          function(e, a) {
            a && a.hideCartLink && t(),
            e && (e.hideCartLink && t(), e.hideCatLink && r(), e.hideSearchLink && o(), e.cartLink && i(e.cartLink), e.homeLink && n(e.homeLink))
          })
        }
      },
      {
        ...
        "value": function() {
          var e = this;
          app.product.onLoad("feature",
          function(t) {
            if (t && t.hideTopNav) a(".header-nav", e.$el).hide();
            else {
              var i = new h(a(".header-nav", e.$el), {
                "floor": "#content div[data-nav]",
                "stickyTopHolder": a("#head").height() - a("#head .header-nav").height()
              });
              app.product.onLoad("scene",
              function(e) {
                e && "tmall" !== e && app.on("updateNav",
                function() {
                  i._render(),
        ...
        "value": function() {
          ...
          function(e) {
            if (e && e.hideTopNav);
              ...
              n = void 0,
              o = function(e) {
                window.pageYOffset > 100 ? i || (t.add("transparent"), i = !0) : i && (t.remove("transparent"), i = !1)
              };
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.product.onLoad(["apis", "tags", "seller", "delivery", "actionBar", "scene"],
          function(t, i, n, o, r, u) {
            var d = navigator.userAgent;
            if (t.cartUrl || r.cartLink) {
              var l = r.cartLink || t.cartUrl;
              if (l += -1 === l.indexOf("?") ? "?cartfrom=detail": "&cartfrom=detail", a(".cart-link", e.$el).attr("href", l), -1 != d.indexOf("MiniProgram") && -1 != d.indexOf("AlipayClient")) {
                a(".cart-link", e.$el).attr("target", "");
                var l = r.cartLink || t.cartUrl;
                l += -1 === l.indexOf("?") ? "?cartFrom=alipay_miniprogram_h5&hideEmptyBtn=true": "&cartFrom=alipay_miniprogram_h5&hideEmptyBtn=true",
                a(".cart-link", e.$el).attr("href", l)
              } else i.isChaoshi && "tmall" === u && e._initChaoshiCart()
      ...
      },
      {
        "key": "initBack",
        "value": function() {
          this.$el.on("click", ".back-link",
          function(e) {
            e.preventDefault(),
            window.WindVane && Ali && Ali.isTaobao ? window.WindVane.call("WebAppInterface", "pop", {}) : window.WindVane && Ali && Ali.isTmall ? window.WindVane.call("TMWVWindow", "back", {}) : navigator.userAgent.indexOf("AliApp(HTAO") > -1 ? window.WindVane.call("WVNative", "nativeBack", {},
            function(e) {},
            function(e) {
              history.back()
          ...
          var e = navigator.userAgent; - 1 != e.indexOf("MiniProgram") && -1 != e.indexOf("AlipayClient") && a(".back-link", this.$el).hide(),
          -1 === e.indexOf("AliApp(TB") && -1 === e.indexOf("AliApp(TM") && -1 === e.indexOf("AliApp(HT") && -1 === e.indexOf("AlipayClient") && (1 === history.length || ~location.href.indexOf("hideBackLink=true")) && a(".back-link", this.$el).hide()
        }
      },
      {
        "key": "initSearch",
        "value": function() {
          var e = this;
          e.product.onLoad("seller",
          function(t) {
            var i = encodeURI('{"user_id":"' + t.userId + '","cat":"50514008"}');
            a(".search-link", e.$el).attr("href", "//s.m.tmall.com/m/searchbar.htm?dim=chaoshi.index.m&searchType=chaoshi&extraParams=" + i + "&actionUrl=%2F%2Flist.tmall.com%2FchaoshiWap.htm")
          });
          var t = navigator.userAgent; - 1 != t.indexOf("MiniProgram") && -1 != t.indexOf("AlipayClient") && a(".search-link", e.$el).hide()
        }
      },
      {
        "key": "initCatLink",
        "value": function() {
          var e = this,
          t = navigator.userAgent; - 1 != t.indexOf("MiniProgram") && -1 != t.indexOf("AlipayClient") && a(".cat-link", e.$el).hide()
        }
      },
      {
        "key": "initHome",
        "value": function() {
          var e = this;
          e.product.onLoad(["scene", "actionBar"],
          function(t, i) {
            if ("qiang" === t) {
              var n = "//tqg.taobao.com/m/jusp/alone/index/mtp.htm?_target=_blank";
              Ali && Ali.isTaobao && Ali.isIOS && (n = "taobao://go/tbqianggoupath"),
              a(".home-link", e.$el).attr("href", n)
            } else "qing" === t && a(".home-link", e.$el).attr("href", "https://ju.taobao.com/m/jusp/o/ppqc/mtp.htm?app=lv&luaview=true")
          })
        }
      },
      {
        ...
        "value": function() {
          ...
          a(window).on("load",
          function() {
            window.require(["mui/tinycart/auto", "mui/chaoshi-app/city-code"],
            function(o, r) {
              t.product.onLoad(["apis", "tags", "seller", "delivery", "skuSelectedPic", "actionBar"],
              function(u, d, l, s, m, c) {
                ...
                f = function() {
                  var r = new o({
                    "monitorFuc": function(e, t) {
                      console.log(e, t),
                      window.goldlog && window.goldlog.record && window.goldlog.record("/tbchaoshi.121.1", "EXP", "", "H79879879")
                    },
                    "imgEl": "img",
                    "tinycartConfig": {
                      "wrapper": t.elStr + " .cart-link",
                      "cartEl": t.elStr + " .cart-link",
                      "sellerId": l.shopId,
                      "terminal": "wap",
                      ...
                      "updatePrice": function(e, t) {
                        "0" === e ? a(t).removeAttr("data-price") : a(t).attr("data-price", "\xa5" + e)
                      },
                      "exParams": {
                        "tpId": String(l.shopId),
                        "divisionCode": String(i) || "330110",
                  ...
                  u = function(e) {
                    var t = this,
                    i = a(t.elStr + " .cart-link")[0];
                    e && e.num ? a(i).attr("data-num", e.num) : a(i).removeAttr("data-num"),
                    t.trigger("renderCart")
                  },
                  d = function(t) {
                    console.log("\u52a0\u8d2dresult", t);
                    var i = a("#s-actionBar-container .trade")[0],
                    n = r.MCart.animation.endElement,
                    o = m && m.image + "_320x320Q50s50.jpg";
                    e(["mui/tinycart/lib/animation"],
                    function(e) {
                      var t = new e(i, n, o);
                      r.MCart._animationRuning = !0,
                      t.on("finish",
                      function() {
                        r.MCart._animationRuning = !1,
                        r.MCart.trigger("animationEnd")
                      }),
                      t.start(),
                      r.MCart.update()
                    })
                  ...
                  r.MCart.on("update",
                  function(e) {
                    r.MCart._animationRuning ? r.MCart.once("animationEnd",
                    function() {
                      u.call(r.MCart, e)
                    }) : u.call(r.MCart, e)
                  }),
    ...
    function() {
      if (Ali && Ali.isTaobao) {
        ...
        if ( - 1 !== location.href.indexOf("disableHideTitle=true")) return ! 1;
        Ali.callWindVane("WebAppInterface.setNaviBarHidden", e)
      }
      if (Ali && Ali.isTmall) {
        if ( - 1 !== location.href.indexOf("disableHideTitle=true")) return ! 1;
        Ali.callWindVane("TMWVWindow.hideTitle", {}),
        Ali.isAndroid && document.addEventListener("visibilitychange",
        function() {
  ...
  define("mui/xtemplate/runtime/escape-html",
  function(e, t, n) {
    function a(e) {
      var t = "" + e,
      n = r.exec(t);
  ...
  define("mui/xtemplate/runtime/util", ["./escape-html"],
  function(e, t, n) {
    var a = e("./escape-html"),
    r = /\\?\{([^{}]+)\}/g,
    ...
    n.exports = o = {
      ...
      "each": function(e, t) {
        ...
        if (e) {
          ...
          if (l) for (i = o.keys(e); s < i.length && (a = i[s], t.call(n, e[a], a, e) !== !1); s++);
          else for (r = e[0]; s < u && t.call(n, r, s, e) !== !1; r = e[++s]);
        }
        return e
      },
      "mix": function(e, t) {
  ...
  define("mui/xtemplate/runtime/scope",
  function(e, t, n) {
    function a(e, t, n) {
      void 0 !== e ? this.data = e: this.data = {},
      n ? (this.parent = n, this.root = n.root) : (this.parent = void 0, this.root = this),
      this.affix = t || {},
      this.ready = !1
    }
    a.prototype = {
  ...
  define("mui/xtemplate/runtime/commands", ["./scope", "./util"],
  function(e, t, n) {
    var a = e("./scope"),
    r = e("./util"),
    i = {
      ...
      "foreach": function(e, t, n) {
        ...
        e),
        c = l.affix,
        "xindex" !== s && (c[s] = h, c.xindex = void 0),
        u && (c[u] = o[h]),
        r = t.fn(l, r);
        return r
      },
      "forin": function(e, t, n) {
        ...
        l = void 0,
        c = void 0;
        if (o) for (c in o) p = new a(o[c], {
          "xindex": c
        },
        e),
        l = p.affix,
        "xindex" !== s && (l[s] = c, l.xindex = void 0),
        u && (l[u] = o[c]),
        r = t.fn(p, r);
        return r
      },
      ...
      "set": function(e, t, n) {
        ...
        o = 0; o < i; o++) {
          ...
          l = s.value;
          if (1 === u.length) {
            for (var c = a.root; p && c !== a;) a = a.parent,
            --p;
            a.set(u[0], l)
          } else {
      ...
      "block": function(e, t, n) {
        ...
        if (l) {
          if (l.type) if ("append" === l.type) h.next = l,
          p[s] = h;
          else if ("prepend" === l.type) {
            var f = void 0;
            for (c = l; c && "prepend" === c.type;) f = c,
            c = c.next;
            h.next = c,
            f.next = h
          }
        } else p[s] = h;
        if (!i.extendTpl) for (c = p[s]; c;) c.fn && (a = c.fn.call(r, e, a)),
        c = c.next;
        return a
      },
  ...
  define("mui/xtemplate/runtime/linked-buffer", ["./util"],
  function(e, t, n) {
    function a(e, t, n) {
      this.list = e,
      this.init(),
  ...
  define("mui/xtemplate/runtime", ["./runtime/util", "./runtime/commands", "./runtime/scope", "./runtime/linked-buffer"],
  function(e, n, r) {
    ...
    function o(e, n, r) {
      ...
      if (o) for (var i = r.length,
      a = 1; a < i; a++) if (o = o[r[a]], !o) return ! 1;
      return o
    }
    function i(e, n) {
      var r = e.split("/"),
    ...
    function a(e, n, r, t, i, a) {
      ...
      if (p !== !1) {
        var c = i.slice(0, -1);
        if (u = n.resolve(c, a), null === u || void 0 === u) return t.error("Execute function `" + i.join(".") + "` Error: " + c.join(".") + " is undefined or null"),
        t;
    ...
    function f(e) {
      ...
      if (n) {
        ...
        var i = r.extendTplFn,
        a = r.extendTplBuffer;
        return i ? (r.extendTpl = null, r.extendTplBuffer = null, r.extendTplFn = null, l(e.root, e.scope, a, e, i).end()) : o && (r.extendTpl = null, r.extendTplBuffer = null, c(e.root, e.scope, 0, a, e, o).end()),
        n.end()
      }
    }
    function d(e, n, r) {
    ...
    u.prototype = {
      ...
      "render": function(e, n, r) {
        ...
        a || (a = function(e, n) {
          var r = e;
          if (r) throw r instanceof Error || (r = new Error(r)),
          r;
          s = n
        });
        var l = this.config.name; ! l && p && p.TPL_NAME && (l = p.TPL_NAME);
        var d = void 0;
  ...
  define("mui/xtemplate/compiler/tools",
  function(e, t, n) {
    function a(e, t) {
    ...
    var p = n.exports = {
      ...
      "convertIdPartsToRawAccessor": function(e, t, n) {
        ...
        l = [],
        c = "";
        for (a = 0, i = n.length; a < i; a++) r = n[a],
        o = r.type,
        o ? (s = e[o](r), p.pushToArray(t, s.source), "function" === o && (c = 1), l.push("[" + s.exp + "]"), u.push(s.exp)) : (l.push("." + r), u.push(p.wrapByDoubleQuote(r)));
        return {
          "str": l.join(""),
          "arr": "[" + u.join(",") + "]",
          "parts": l,
  ...
  define("mui/xtemplate/compiler/parser",
  function(e, t, n) {
    var a = function(e) {
      function t(e, t) {
        return t = t || 1,
      ...
      function i(e, t, n) {
        if (e) {
          var i, r, o, s = 0;
          if (n = n || null, a(e)) for (o = e.length, r = e[0]; s < o && t.call(n, r, s, e) !== !1; r = e[++s]);
          else for (i in e) if (t.call(n, e[i], i, e) === !1) break
        }
      }
      function r(e, t) {
        for (var n = 0,
        a = t.length; n < a; n++) if (t[n] === e) return ! 0;
        return ! 1
      }
      var o = {},
      s = {
      ...
      var p = new u({
        ...
        function() {
          ...
          a % 2 ? (t.pushState("et"), n = n.slice(0, -1)) : t.pushState("t"),
          a && (n = n.replace(/\\+$/g,
          function(e) {
        ...
        ["p", "e"]], ["z", /^\d+(?:\.\d+)?(?:e-?\d+)?/i, 0, ["p", "e"]], ["aa", /^=/, 0, ["p", "e"]], ["ab", /^\.\./,
        function() {
          this.pushState("ws")
        },
        ["p", "e"]], ["ac", /^\//,
      ...
      o.productions = [["ai", ["aj"]], ["aj", ["ak", "e", "ak"],
      function() {
  ...
  define("mui/xtemplate/compiler/ast",
  function(e, t, n) {
    function r(e, t) {
      var n = e.length,
      r = t.length;
  ...
  define("mui/xtemplate/compiler", ["./runtime", "./compiler/tools", "./compiler/parser", "./compiler/ast"],
  function(e, r, t) {
    function n(e, r) {
    ...
    function i(e) {
      ...
      m(r, s),
      r.push("var " + c + " = " + n + ";"),
      "&&" === t || "||" === t ? (r.push("if(" + ("&&" === t ? "": "!") + "(" + c + ")){"), m(r, i), r.push(c + " = " + o + ";"), r.push("}")) : (m(r, i), r.push(c + " = (" + n + ") " + t + " (" + o + ");")),
      {
        "exp": c,
        "source": r
      }
    ...
    function u(e, r) {
      for (var t = a(e, "func"), n = s(t), o = void 0, i = 0, u = r.length; i < u; i++) o = r[i],
    ...
    function c(e, r) {
      ...
      s = void 0,
      a = void 0;
      for (s = 0, a = r.length; s < a; s++) o = r[s],
      m(n, e[o.type](o, {
        "top": 1
      }).source);
      return n.splice.apply(n, [2, 0].concat(e.functionDeclares).concat("")),
      n.push(J),
      t && (n.push("} catch(e) {"), n.push("if(!e.xtpl){"), n.push("buffer.error(e);"), n.push("}else{ throw e; }"), n.push("}")),
      {
        "params": ["undefined"],
        "source": n.join("\n")
      }
    ...
    function f(e, r, t, o) {
      ...
      if (t) {
        ...
        D = g.statements,
        U = [];
        for (y = 0; y < D.length; y++) B = D[y],
        "expressionStatement" === B.type && (I = B.value) && (I = I.parts) && 1 === I.length && (I = I[0]) && "function" === I.type && "elseif" === I.id.string ? (C && A.push(C), C = {
    ...
    v.prototype = {
      ...
      "arrayExpression": function(e) {
        ...
        t = r.length,
        n = void 0,
        o = [], s = [], a = 0; a < t; a++) n = this[r[a].type](r[a]),
        m(o, n.source),
        s.push(n.exp);
        return {
          "exp": "[ " + s.join(",") + " ]",
      ...
      "id": function(e) {
        ...
        t = this,
        o = !t.config.strict;
        if (n(e.pos, r), d.isGlobalId(e)) return {
          "exp": e.string,
          "source": r
        };
        var s = e.depth,
        ...
        if ("function" === i[0].type) {
          ...
          var h = void 0;
          if (o) h = d.genStackJudge(f.slice(1), f[0]);
          else {
            h = f[0];
  ...
  define("mui/xtemplate/index", ["./runtime", "./compiler"],
  function(e, r, t) {
    function n(e, r) {
      var t = e,
      o = r,
  ...
  define("detail-m/mods/content/part.xtpl",
  function(e, t, n) {
    ...
    n.exports = function(e, t) {
      var n, i = function(e) {
        function t(e, t, n) {
          e.data,
          e.affix;
          return t.data += ' <div class="group-warp"> ',
          t
        }
        function n(e, t, n) {
          var i = e.data,
          a = e.affix,
          o = (d = a.index) !== n ? d: (d = i.index) !== n ? d: e.resolveLooseUp(["index"]),
          r = o,
          ...
          if (u) {
            ...
            f = !m;
            if (!f) {
              var v = (d = a.index) !== n ? d: (d = i.index) !== n ? d: e.resolveLooseUp(["index"]),
              h = v;
              h = v - 1;
            ...
            if (!g) {
              ...
              if (k) {
                ...
                S = I;
                S = I - 1;
                T = A !== ((d = a.modules) !== n ? null != d ? null != (c = d[S]) ? p = c.groupId: c: d: (d = i.modules) !== n ? null != d ? null != (c = d[S]) ? p = c.groupId: c: d: e.resolveLooseUp(["modules", S, "groupId"])),
                k = T
              }
              g = k
            }
        ...
        function i(e, t, n) {
          e.data,
          e.affix;
          return t.data += ' </div><div class="group-warp"> ',
          t
        }
        function a(e, t, n) {
          var i = e.data,
          a = e.affix;
          t.data += ' data-exp="';
          var o, r = (d = a.item) !== n ? null != d ? c = d.key: d: (d = i.item) !== n ? null != d ? c = d.key: d: e.resolveLooseUp(["item", "key"]),
          ...
          t, ["$utils", "JSON", "stringify"]);
          var s = o;
          return t = t.writeEscaped(s),
          t.data += '" ',
          t
        }
        function o(e, t, n) {
          ...
          t = t.writeEscaped(r),
          t.data += '" ';
          var l = (d = o.$utils) !== n ? d: (d = i.$utils) !== n ? d: e.resolveLooseUp(["$utils"]),
          s = l;
          if (s) {
            s = (d = o.detailData) !== n ? null != d ? c = d.traceDatas: d: (d = i.detailData) !== n ? null != d ? c = d.traceDatas: d: e.resolveLooseUp(["detailData", "traceDatas"])
          }
          var u = s;
          if (u) {
            var f = (d = o.item) !== n ? null != d ? c = d.key: d: (d = i.item) !== n ? null != d ? c = d.key: d: e.resolveLooseUp(["item", "key"]);
            u = (d = o.detailData) !== n ? null != d ? null != (c = d.traceDatas) ? p = c[f] : c: d: (d = i.detailData) !== n ? null != d ? null != (c = d.traceDatas) ? p = c[f] : c: d: e.resolveLooseUp(["detailData", "traceDatas", f])
          }
          return t = A.call(m, e, {
            "params": [u],
            "fn": a
        ...
        function l(e, t, n) {
          ...
          t = t.writeEscaped(o),
          t.data += '" ';
          var l = (d = a.$utils) !== n ? d: (d = i.$utils) !== n ? d: e.resolveLooseUp(["$utils"]),
          s = l;
          if (s) {
            s = (d = a.detailData) !== n ? null != d ? c = d.traceDatas: d: (d = i.detailData) !== n ? null != d ? c = d.traceDatas: d: e.resolveLooseUp(["detailData", "traceDatas"])
          }
          var u = s;
          if (u) {
            var f = (d = a.item) !== n ? null != d ? c = d.key: d: (d = i.item) !== n ? null != d ? c = d.key: d: e.resolveLooseUp(["item", "key"]);
            u = (d = a.detailData) !== n ? null != d ? null != (c = d.traceDatas) ? p = c[f] : c: d: (d = i.detailData) !== n ? null != d ? null != (c = d.traceDatas) ? p = c[f] : c: d: e.resolveLooseUp(["detailData", "traceDatas", f])
          }
          return t = A.call(m, e, {
            "params": [u],
            "fn": r
        ...
        function u(e, a, r) {
          ...
          p = e.affix;
          a.data += " ";
          var f = (d = p.index) !== r ? d: (d = u.index) !== r ? d: e.resolveLooseUp(["index"]),
          v = f;
          v = 0 === f,
          a = A.call(m, e, {
            "params": [v],
          ...
          a),
          a.data += " ";
          var h = (d = p.item) !== r ? null != d ? c = d.key: d: (d = u.item) !== r ? null != d ? c = d.key: d: e.resolveLooseUp(["item", "key"]),
          g = h;
          if (g) {
            var y;
            y = w(m, e, {
          ...
          a),
          a.data += " ";
          var k = (d = p.index) !== r ? d: (d = u.index) !== r ? d: e.resolveLooseUp(["index"]),
          T = k,
          I = (d = p.modules) !== r ? null != d ? c = d.length: d: (d = u.modules) !== r ? null != d ? c = d.length: d: e.resolveLooseUp(["modules", "length"]),
          S = I;
          return S = I - 1,
          T = k === S,
          a = A.call(m, e, {
        ...
        v = m.buffer,
        h = m.scope,
        g = (m.runtime, m.name, m.pos, h.data),
        y = h.affix,
        x = f.nativeCommands,
        b = f.utils,
        w = b.callFn,
  ...
  define("detail-m/mods/content/index", ["mui/zepto/zepto", "./part.xtpl"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    u = function() {
      ...
      return o(t, [{
        ...
        "value": function() {
          ...
          e.xtplArr = [],
          e.moduleArr = [],
          e.product.onLoad(["detailData", "modules"],
          function(t, i) {
            e.doms = a(".module-wrap", e.$el),
            0 == e.doms.length && (e.$el.html(r({
              "modules": i,
              "detailData": t
            })), e.doms = a(".module-wrap", e.$el)),
            ...
            i.forEach && i.forEach(function(t, i) {
              if (0 == t.key.indexOf("detail-mods") && t.version) {
                ...
                if (!feloader.Config.packages[n] || 0 == n.indexOf("detail-mods")) {
                  var o = {},
                  a = e.app.getWhSeedVersion(n) || t.version;
                  o[n] = {
                    "path": "//g.alicdn.com/" + n + "/" + a + "/",
                    "name": n,
                    "version": a,
                    "ignorePackageNameInUri": !0
                  },
              ...
              } else e.xtplArr.push("detail-m/" + t.key + ".xtpl"),
              e.moduleArr.push(t)
            }),
            window.require(e.xtplArr,
            function() {}),
            e.initSyncMods(),
            e.renderAllMods()
          })
        ...
        "value": function() {
          ...
          if (t.moduleArr && t.moduleArr.length > 0) t.moduleArr.forEach(function(i, n) {
            ...
            if (a && o && !o.inited) {
              ...
              e([r],
              function(e) {
                "function" == typeof e && (e(a, i.data || {},
                t.app), batTrack("init." + i.key, "mods.init"))
              })
            }
          });
          else {
            var i = function() {
              ...
              o = a(t.map[n]),
              r = o.children();
              r[0] && (t.map[n].inited = !0, e([r.attr("data-mod-name")],
              function(e) {
                "function" == typeof e && (e(r[0], {},
                t.app), batTrack("init." + i, "mods.init"))
              }))
            };
      ...
      },
      {
        ...
        "value": function() {
          var t = this;
          t.product.onLoad(["traceDatas", "detailData"],
          function(i, n) {
            function o(o) {
              function u(o, u) {
                var l = t.moduleArr[u] || {},
                ...
                d = l.groupId;
                var m = i[l.key] && JSON.stringify(i[l.key]) || "",
                c = t.map[l.key];
                if (c) {
                  if (c.sync = !0, c.id = "J_mod" + u, c.groupId = l.groupId, r[u] = c, !c.inited) {
                    ...
                    try {
                      ...
                      console.log('render "' + t.xtplArr[u] + '" error'),
                      batTrack("mods.render.err", "mods.init", {
                        "type": "error",
                    ...
                    var f = void 0;
                    a(p).appendTo(c),
                    f = a("#J_mod" + u, t.$el).children(),
                    e([f.attr("data-mod-name")],
                    function(e) {
                      "function" == typeof e ? (e(f, s || {},
                      t.app), batTrack("init." + l.key, "mods.init")) : batTrack("init.err." + l.key, "mods.init", {
                        "type": "error",
                        "msg": location.href
                      })
                    })
              ...
              o ? (o.forEach(function(e, t) {
                u(e, t)
              }), Object.keys(t.map).forEach(function(e) { ! 0 !== t.map[e].sync && a(t.map[e]).remove()
              })) : t.xtplArr.forEach(function(e, t) { - 1 === feloader.getModule(e).status && (feloader.getModule(e).status = 0),
                window.require([e],
                function(e) {
                  u(e, t)
                },
            ...
            var r = [];
            window.require(t.xtplArr,
            function() {
              for (var e = arguments.length,
              i = Array(e), n = 0; n < e; n++) i[n] = arguments[n];
              o(i),
              t.app.trigger("updateNav")
            },
            function(e) {
              o(null),
              batTrack("mods.xtpl.err", "mods.init", {
                "type": "error",
                "msg": e.error.exception
              })
            })
          })
        }
  ...
  define("detail-m/mods/module-preview/index", ["mui/slider-m/index", "mui/zepto/zepto", "mui/crossimage/index", "mui/zepto/touch", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e) {
      return e && e.__esModule ? e: {
        "default": e
    ...
    p = function() {
      ...
      },
      {
        ...
        "value": function(e) {
          var t = this;
          t.app.product.onLoad(["detailData", "item", "scene"],
          function(i, n, a) {
            var o = [],
            ...
            r && (o.push(r.videoThumbnailURL || n.images[0]), t.spatialVideoDimension = r.spatialVideoDimension, t.spatialVideoDimension),
            o = o.concat(n.images),
            t.appVideo = !1;
            var u = function(i) {
              var n = !1;
              for (var a in i) if (i.hasOwnProperty(a)) if (Array.isArray(i[a])) {
                for (var o = !1,
                r = 0; r < i[a].length; ++r) if (i[a][r] && d[a][r] && i[a][r].replace(/^https?:/g, "") === d[a][r].replace(/^https?:/g, "")) {
                  o = !0;
                  break
                }
                n = !o
            ...
            if ("tmall" === a) if (r) {
              var s = navigator.userAgent; - 1 !== s.indexOf("AliApp(") || -1 !== s.indexOf("AlipayClient") ? (r && (t.hasVideo = !0), u({
                "images": o,
                "video": r,
                "appVideo": t.appVideo
              })) : t.app.onSmartbanner(function(e, i) {
                t.appVideo = !(!i || !i.isShow),
                t.appVideo && (t.hasVideo = !0, t.smbInstance = e.getInstance({
                  "type": "func",
                  "bizKey": "taobao",
      ...
      },
      {
        ...
        "value": function() {
          var t = this;
          l(t.el).on("click", ".item",
          function(i) {
            var n = (l(i.target), l(i.currentTarget));
            if (i.currentTarget.dataset.video) return void(t.appVideo && t.smbInstance ? t.smbInstance.redirect(!0) : t.video ? n.hasClass("item-video-play") ? t.video.pause() : t.video.play() : (n.addClass("item-video-init"), e(["mui/videox/index"],
            function(e) {
              var a = e["default"];
              t.video = new a({
              ...
              t.video.on("video:play",
              function(e) {
                n.addClass("item-video-play")
              }),
              t.video.on("video:pause",
              function(e) {
          ...
          l(t.el).on("click", ".nav .videos,.nav .images",
          function(e) {
  ...
  define("detail-m/mods/module-jhs/index", ["mui/zepto/zepto", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    function a(e, t, i, n) {
      var a = -1;
      if (a = e > 0 ? i - n: t - n, e > 0 && a <= 0) {
        var o = d("#J_PriceBar .subleft");
        return o.addClass("timeout"),
        {
          "timeout": !0,
          "formatTxt": "\u6d3b\u52a8\u5df2\u7ed3\u675f",
          "tuanClock": "\u4e0b\u6b21\u65e9\u70b9\u6765"
      ...
      if (a <= 0 && 0 == e) {
        a = t - n,
        e = 1;
        var o = d("#J_PriceBar .nobegin");
        o && o.removeClass("nobegin")
      }
      var r = parseInt(a / 1e3 / 60 / 60),
      u = parseInt(r / 24, 10),
      l = parseInt(a % 36e5 / 6e4, 10),
      s = parseInt(a % 6e4 / 1e3, 10),
      c = parseInt(a % 1e3 / 100, 10),
      m = "",
      p = -1;
      if (e > 0) r >= 72 ? (m = "\u4ec5\u5269" + u + "\u5929", p = r % 24) : (m = "\u8ddd\u7ed3\u675f\u5269\u4f59", p = r);
      else {
        var f = "",
        v = !1;
        p = r % 24;
        var h = new Date(parseFloat(t)),
        g = new Date(parseFloat(n)),
        x = (g.getDate(), h.getDate()),
        y = h.getHours(),
        k = g.getHours(),
        b = g.getMinutes(),
        w = g.getSeconds(),
        ...
        1 == (y + "").length && (y = "0" + y);
        var A = h.getMinutes();
        if (1 == (A + "").length && (A = "0" + A), r + k + S >= 72) {
          var q = h.getMonth() + 1;
          1 == (q + "").length && (q = "0" + q),
          m = q + "\u6708" + x + "\u65e5",
          f = y + ":" + A + "  \u5f00\u62a2",
          v = !0
        } else m = r + k + S >= 48 ? "\u540e\u5929" + y + ":" + A + "  \u5f00\u62a2": r + k + S >= 24 ? "\u660e\u5929" + y + ":" + A + "  \u5f00\u62a2": "\u8ddd" + y + ":" + A + "  \u5f00\u62a2"
      }
      return p = r,
      1 == (p + "").length && (p = "0" + p),
      1 == (l + "").length && (l = "0" + l),
    ...
    s = function() {
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onLoad(["jhs", "price"],
          function(t, i) {
            null != (t && t.status) && (t.hasIntervalPrice ? d(e.el).html(new u(l).render({
      ...
      },
      {
        ...
        "value": function() {
          var e = this,
          t = d("#J_tuanTime", e.el)[0],
          i = d("#J_CountDownTxt", e.el)[0],
          n = d("#J_TimeHour", e.el)[0],
          o = d("#J_TimeMin", e.el)[0],
          r = d("#J_TimeSec", e.el)[0],
          u = d("#J_TimeWSec", e.el)[0],
          l = d(".clockrun .num , .clockrun .dot");
          e.app.product.onLoad(["jhs", "systemTime"],
          function(e, d) {
            function s() {
              c += 100;
              var e = a(f, m, p, c);
              e.tuanClock ? e.timeout ? (i.innerHTML = e.formatTxt, t.innerHTML = e.tuanClock, l.addClass("hideTime")) : e.noCountdown && (i.innerHTML = e.formatTxt, t.innerHTML = e.tuanClock, l.addClass("hideTime")) : (t && (t.innerHTML = ""), i.innerHTML = e.formatTxt, n.innerHTML = e.formatHour, o.innerHTML = e.surplusMinute, r.innerHTML = e.surplusSecond, u.innerHTML = e.surplusMillSecond, l.removeClass("hideTime"), setTimeout(s, 100))
            }
            var c = d,
            m = e.startTime,
            p = e.endTime,
  ...
  define("detail-m/mods/module-focus/index", ["mui/zepto/zepto", "mui/crossimage/index", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    s = function() {
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onLoad("double11Banner",
          function(t) {
            t && t.icon && r(e.el).html(new u(l).render({
              "double11Banner": d.getFitUrl(t.icon, window.screen.width, window.screen.width, {
                "clean": !0
              })
            }))
          })
  ...
  define("detail-m/mods/module-price/index", ["mui/zepto/zepto", "./part.xtpl", "detail-m/mods/module-price/promotion.js", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    r = e("mui/zepto/zepto"),
    d = e("./part.xtpl"),
    u = e("detail-m/mods/module-price/promotion.js"),
    l = e("mui/xtemplate/index"),
    s = '{{#if(isG9Item)}}\n<div class="g9-area-wrap">\n        <img class="g9-area-bg" src="{{g9Price.bgIcon}}" />\n        <div class="g9-area-inner">\n            <div class="g9-area-inner-top">\n            <span class="g9-area-price-little">\uffe5</span> <span class="g9-area-price">{{g9Price.price}}</span>\n             <span class="g9-area-oprice">{{g9Price.extraPrices}}</span>\n            </div>\n            <span class="g9-priceTag">{{g9Price.priceTag}}</span>\n        </div>\n</div>\n{{/if}}',
    c = function() {
      function e(t) {
        n(this, e),
        this.el = t.el,
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onChange(["price", "delivery", "presale", "jhs", "meiLiHui", "item", "sku2info", "selectedSku", "isPreSale", "entrances", "newBigPromotion", "vertical", "feature"],
          function(t, i, n, a, o, c, m, p, f, v, h, g, x) {
            if (x.isG9Item && g.g9Price) return r(".module-price").css({
              "padding": "0 0 10px 0"
            }),
            void r(e.el).html(new l(s).render({
              "isG9Item": x.isG9Item,
              "g9Price": g.g9Price
            }));
            var y = !x.hideNewPriceBanner || "false" === x.hideNewPriceBanner || /debug_price_banner/.test(location.href);
            if (h && h.bgIcon && y) {
              new u(e.el, e.config, e.app);
              var b = r(".module-wrap .module-focus");
              return b && b.hide(),
              !0
            }
            var k = p && p.skuId || 0;
            console.log(x.isG9Item && g.g9Price, "3687"),
            r(e.el).html(d({
              "isG9": x.isG9Item && g.g9Price,
              "price": t || {},
              "delivery": i || {},
              "presale": n || {},
              "isPreSale": f,
              ...
              "meiLiHui": o || {},
              "item": c,
              "appPromotion": m[k] ? m[k].app: "",
              "alipaySellingPoints": v && v.alipaySellingPoints,
              "mobileReleaseData": g && g.mobileReleaseData ? g.mobileReleaseData: null
            }))
          })
        }
      }]),
  ...
  define("detail-m/mods/module-price/part.xtpl",
  function(e, t, n) {
    var i = e("mui/xtemplate/index");
    n.exports = function(e, t) {
      var n, i = function(e) {
        function t(e, t, n) {
          ...
          var o = (D = a.price) !== n ? null != D ? null != (z = D.price) ? _ = z.priceTitle: z: D: (D = i.price) !== n ? null != D ? null != (z = D.price) ? _ = z.priceTitle: z: D: e.resolveLooseUp(["price", "price", "priceTitle"]);
        ...
        function i(e, t, n) {
          ...
          a = e.affix;
          t.data += "";
          var o = (D = a.price) !== n ? null != D ? null != (z = D.price) ? _ = z.priceChar: z: D: (D = i.price) !== n ? null != D ? null != (z = D.price) ? _ = z.priceChar: z: D: e.resolveLooseUp(["price", "price", "priceChar"]);
          return t = t.writeEscaped(o),
          t.data += "",
          t
        }
        ...
        function l(e, t, n) {
          ...
          a = e.affix;
          t.data += ' <span class="ui-label">';
          var l = (D = a.price) !== n ? null != D ? null != (z = D.subPrice) ? _ = z.priceTitle: z: D: (D = i.price) !== n ? null != D ? null != (z = D.subPrice) ? _ = z.priceTitle: z: D: e.resolveLooseUp(["price", "subPrice", "priceTitle"]);
          t = t.writeEscaped(l),
          t.data += '</span><span class="ui-yen"><i class="price-symbol subPrice-symbol">';
          var s = (D = a.price) !== n ? null != D ? null != (z = D.price) ? _ = z.priceChar: z: D: (D = i.price) !== n ? null != D ? null != (z = D.price) ? _ = z.priceChar: z: D: e.resolveLooseUp(["price", "price", "priceChar"]);
          t = H.call(O, e, {
            "params": [s],
            "fn": o,
            "inverse": r
          ...
          t),
          t.data += '</i><span class="subPrice">';
          var d = (D = a.price) !== n ? null != D ? null != (z = D.subPrice) ? _ = z.priceText: z: D: (D = i.price) !== n ? null != D ? null != (z = D.subPrice) ? _ = z.priceText: z: D: e.resolveLooseUp(["price", "subPrice", "priceText"]);
          return t = t.writeEscaped(d),
          t.data += "</span></span> ",
          t
        }
        function s(e, t, n) {
          ...
          var o = (D = a.item) !== n ? null != D ? z = D.icon: D: (D = i.item) !== n ? null != D ? z = D.icon: D: e.resolveLooseUp(["item", "icon"]);
          return t = t.writeEscaped(o),
          t.data += '"> ',
          t
        }
        function d(e, t, n) {
          var i = e.data,
          a = e.affix;
          return (D = a.item) !== n ? null != D ? z = D.text: D: (D = i.item) !== n ? null != D ? z = D.text: D: e.resolveLooseUp(["item", "text"])
        }
        function u(e, t, n) {
          var i = e.data,
          a = e.affix;
          t.data += ' <span class="icon-text">';
          var o = (D = a.item) !== n ? null != D ? z = D.text: D: (D = i.item) !== n ? null != D ? z = D.text: D: e.resolveLooseUp(["item", "text"]);
          return t = t.writeEscaped(o),
          t.data += "</span> ",
          t
        }
        ...
        function p(e, t, n) {
          ...
          a = e.affix;
          t.data += " ",
          t.data += ' <div class="price-desc">';
          var o = (D = a.price) !== n ? null != D ? null != (z = D.price) ? _ = z.priceDesc: z: D: (D = i.price) !== n ? null != D ? null != (z = D.price) ? _ = z.priceDesc: z: D: e.resolveLooseUp(["price", "price", "priceDesc"]);
          return t = t.writeEscaped(o),
          t.data += "</div> ",
          t
        }
        function m(e, t, n) {
          e.data,
          e.affix;
          return t.data += ' class="no-through" ',
          t
        }
        function f(e, t, n) {
          var i = e.data,
          a = e.affix;
          t.data += ' style="color:';
          var o = (D = a.item) !== n ? null != D ? z = D.priceColor: D: (D = i.item) !== n ? null != D ? z = D.priceColor: D: e.resolveLooseUp(["item", "priceColor"]);
          return t = t.writeEscaped(o),
          t.data += '" ',
          t
        }
        function v(e, t, n) {
          ...
          a = e.affix;
          t.data += "";
          var o = (D = a.item) !== n ? null != D ? z = D.priceChar: D: (D = i.item) !== n ? null != D ? z = D.priceChar: D: e.resolveLooseUp(["item", "priceChar"]);
          return t = t.writeEscaped(o),
          t.data += "",
          t
        }
        ...
        function g(e, t, n) {
          ...
          var o = (D = a.item) !== n ? null != D ? z = D.priceTitle: D: (D = i.item) !== n ? null != D ? z = D.priceTitle: D: e.resolveLooseUp(["item", "priceTitle"]);
          t = t.writeEscaped(o),
          t.data += ":</label> <del ";
          var r = (D = a.item) !== n ? null != D ? z = D.lineThrough: D: (D = i.item) !== n ? null != D ? z = D.lineThrough: D: e.resolveLooseUp(["item", "lineThrough"]);
          t = H.call(O, e, {
            "params": [!r],
            "fn": m
          },
          t),
          t.data += " ";
          var l = (D = a.item) !== n ? null != D ? z = D.priceColor: D: (D = i.item) !== n ? null != D ? z = D.priceColor: D: e.resolveLooseUp(["item", "priceColor"]);
          t = H.call(O, e, {
            "params": [l],
            "fn": f
          },
          t),
          t.data += ">";
          var s = (D = a.item) !== n ? null != D ? z = D.priceChar: D: (D = i.item) !== n ? null != D ? z = D.priceChar: D: e.resolveLooseUp(["item", "priceChar"]);
          t = H.call(O, e, {
            "params": [s],
            "fn": v,
            "inverse": h
          ...
          t),
          t.data += "";
          var d = (D = a.item) !== n ? null != D ? z = D.priceText: D: (D = i.item) !== n ? null != D ? z = D.priceText: D: e.resolveLooseUp(["item", "priceText"]);
          return t = t.writeEscaped(d),
          t.data += "</del></div> ",
          t
        }
        function x(e, t, n) {
          ...
          a = e.affix;
          t.data += ' style="color:';
          var o = (D = a.item) !== n ? null != D ? z = D.color: D: (D = i.item) !== n ? null != D ? z = D.color: D: e.resolveLooseUp(["item", "color"]);
          return t = t.writeEscaped(o),
          t.data += '" ',
          t
        }
        function y(e, t, n) {
          ...
          t),
          t.data += ">";
          var r = (D = a.item) !== n ? null != D ? z = D.text: D: (D = i.item) !== n ? null != D ? z = D.text: D: e.resolveLooseUp(["item", "text"]);
        ...
        function w(e, o, r) {
          ...
          d = e.affix;
          o.data += " ",
          o.data += ' <div class="real-price"> ';
          var u = (D = d.price) !== r ? null != D ? null != (z = D.price) ? _ = z.priceTitle: z: D: (D = s.price) !== r ? null != D ? null != (z = D.price) ? _ = z.priceTitle: z: D: e.resolveLooseUp(["price", "price", "priceTitle"]);
          o = H.call(O, e, {
            "params": [u],
            "fn": t
          },
          o),
          o.data += ' <span class="ui-yen ';
          var m = (D = d.price) !== r ? null != D ? z = D.subPrice: D: (D = s.price) !== r ? null != D ? z = D.subPrice: D: e.resolveLooseUp(["price", "subPrice"]);
          o = H.call(O, e, {
            "params": [m],
            "fn": n
          },
          o),
          o.data += '"><i class="price-symbol">';
          var f = (D = d.price) !== r ? null != D ? null != (z = D.price) ? _ = z.priceChar: z: D: (D = s.price) !== r ? null != D ? null != (z = D.price) ? _ = z.priceChar: z: D: e.resolveLooseUp(["price", "price", "priceChar"]);
          o = H.call(O, e, {
            "params": [f],
            "fn": i,
            "inverse": a
          ...
          o),
          o.data += '</i><span class="price">';
          var v = (D = d.price) !== r ? null != D ? null != (z = D.price) ? _ = z.priceText: z: D: (D = s.price) !== r ? null != D ? null != (z = D.price) ? _ = z.priceText: z: D: e.resolveLooseUp(["price", "price", "priceText"]);
          o = o.writeEscaped(v),
          o.data += "</span></span> ";
          var h = (D = d.price) !== r ? null != D ? z = D.subPrice: D: (D = s.price) !== r ? null != D ? z = D.subPrice: D: e.resolveLooseUp(["price", "subPrice"]);
          o = H.call(O, e, {
            "params": [h],
            "fn": l
          },
          o),
          o.data += " ";
          var x = (D = d.price) !== r ? null != D ? z = D.priceTag: D: (D = s.price) !== r ? null != D ? z = D.priceTag: D: e.resolveLooseUp(["price", "priceTag"]);
          o = X.call(O, e, {
            "params": [x, "item", "index"],
            "fn": c
          },
          o),
          o.data += " </div> ";
          var w = (D = d.price) !== r ? null != D ? null != (z = D.price) ? _ = z.priceDesc: z: D: (D = s.price) !== r ? null != D ? null != (z = D.price) ? _ = z.priceDesc: z: D: e.resolveLooseUp(["price", "price", "priceDesc"]);
          o = H.call(O, e, {
            "params": [w],
            "fn": p
          },
          o),
          o.data += " ";
          var b = (D = d.price) !== r ? null != D ? z = D.extraPrices: D: (D = s.price) !== r ? null != D ? z = D.extraPrices: D: e.resolveLooseUp(["price", "extraPrices"]);
          o = X.call(O, e, {
            "params": [b, "item", "index"],
            "fn": g
          },
          o),
          o.data += " ";
          var k = (D = d.price) !== r ? null != D ? z = D.wholePriceDescs: D: (D = s.price) !== r ? null != D ? z = D.wholePriceDescs: D: e.resolveLooseUp(["price", "wholePriceDescs"]);
          return o = X.call(O, e, {
            "params": [k, "item", "index"],
            "fn": y
          },
        ...
        function b(e, t, n) {
          ...
          a = e.affix;
          t.data += " ",
          t.data += ' <a href="//pages.tmall.com/wow/portal/act/app-download?type=detail&key=';
          var o = (D = a.item) !== n ? null != D ? z = D.itemId: D: (D = i.item) !== n ? null != D ? z = D.itemId: D: e.resolveLooseUp(["item", "itemId"]);
          t = t.writeEscaped(o),
          t.data += '&mmstat=detail_price&src=wapbutton&dl_ttid=wapbutton" class="maokeapp-price">';
          var r = (D = a.appPromotion) !== n ? D: (D = i.appPromotion) !== n ? D: e.resolveLooseUp(["appPromotion"]);
          return t = t.writeEscaped(r),
          t.data += "</a> ",
          t
        }
        function k(e, t, n) {
          ...
          a = e.affix;
          t.data += " ",
          t.data += ' <div class="price-tips expand-text">';
          var o = (D = a.price) !== n ? null != D ? z = D.depositPriceTip: D: (D = i.price) !== n ? null != D ? z = D.depositPriceTip: D: e.resolveLooseUp(["price", "depositPriceTip"]);
          return t = t.writeEscaped(o),
          t.data += "</div> ",
          t
        }
        ...
        function T(e, t, n) {
          ...
          t.data += " ",
          t.data += " ",
          t.data += ' <div class="price-tips ';
          var o = (D = a.isPreSale) !== n ? D: (D = i.isPreSale) !== n ? D: e.resolveLooseUp(["isPreSale"]);
          t = H.call(O, e, {
            "params": [o],
            "fn": A
          },
          t),
          t.data += '">';
          var r = (D = a.price) !== n ? null != D ? z = D.priceTip: D: (D = i.price) !== n ? null != D ? z = D.priceTip: D: e.resolveLooseUp(["price", "priceTip"]);
          return t = t.writeEscaped(r),
          t.data += "</div> ",
          t
        }
        function C(e, t, n) {
          ...
          t.data += " ",
          t.data += ' <div class="price-tips">';
          var o = (D = a.item) !== n ? null != D ? null != (z = D.infoText) ? null != (_ = z.amountPromLimit) ? U = _.text: _: z: D: (D = i.item) !== n ? null != D ? null != (z = D.infoText) ? null != (_ = z.amountPromLimit) ? U = _.text: _: z: D: e.resolveLooseUp(["item", "infoText", "amountPromLimit", "text"]);
          return t = t.writeEscaped(o),
          t.data += "</div> ",
          t
        }
        function I(e, t, n) {
          ...
          t.data += " ",
          t.data += ' <div class="price-tips">';
          var o = (D = a.item) !== n ? null != D ? null != (z = D.infoText) ? null != (_ = z.pricedCouponInfo) ? U = _.text: _: z: D: (D = i.item) !== n ? null != D ? null != (z = D.infoText) ? null != (_ = z.pricedCouponInfo) ? U = _.text: _: z: D: e.resolveLooseUp(["item", "infoText", "pricedCouponInfo", "text"]);
          return t = t.writeEscaped(o),
          t.data += "</div> ",
          t
        }
        function L(e, t, n) {
          ...
          var o = (D = a.presale) !== n ? null != D ? z = D.tip: D: (D = i.presale) !== n ? null != D ? z = D.tip: D: e.resolveLooseUp(["presale", "tip"]);
          return t = t.writeEscaped(o),
          t.data += "</div> ",
          t
        }
        function S(e, t, n) {
          ...
          a = e.affix;
          t.data += '<img src="';
          var o = (D = a.alipaySellingPoints) !== n ? null != D ? z = D.icon: D: (D = i.alipaySellingPoints) !== n ? null != D ? z = D.icon: D: e.resolveLooseUp(["alipaySellingPoints", "icon"]);
          return t = t.writeEscaped(o),
          t.data += '">',
          t
        }
        function P(e, t, n) {
          ...
          t),
          t.data += "";
          var r = (D = a.alipaySellingPoints) !== n ? null != D ? z = D.text: D: (D = i.alipaySellingPoints) !== n ? null != D ? z = D.text: D: e.resolveLooseUp(["alipaySellingPoints", "text"]);
          return t = t.writeEscaped(r),
          t.data += "</div> ",
          t
        }
        function E(e, t, n) {
          ...
          var o = (D = a.delivery) !== n ? null != D ? null != (z = D.extras) ? null != (_ = z.ShipTime) ? U = _.text: _: z: D: (D = i.delivery) !== n ? null != D ? null != (z = D.extras) ? null != (_ = z.ShipTime) ? U = _.text: _: z: D: e.resolveLooseUp(["delivery", "extras", "ShipTime", "text"]);
          return t = t.writeEscaped(o),
          t.data += "</div> ",
          t
        }
        ...
        q = O.buffer,
        B = O.scope,
        M = (O.runtime, O.name, O.pos, B.data),
        F = B.affix,
        N = j.nativeCommands,
        $ = j.utils,
        X = ($.callFn, $.callDataFn, $.callCommand, N.range, N["void"], N.foreach, N.forin, N.each),
        H = (N["with"], N["if"]);
        N.set,
        N.include,
        N.parse,
        ...
        N["debugger"];
        q.data += "";
        var R = (D = F.jhs) !== e ? null != D ? z = D.status: D: (D = M.jhs) !== e ? null != D ? z = D.status: D: B.resolveLooseUp(["jhs", "status"]),
        W = R;
        W = R >= 0;
        var V = W;
        if (!V) {
          var J = (D = F.meiLiHui) !== e ? null != D ? z = D.status: D: (D = M.meiLiHui) !== e ? null != D ? z = D.status: D: B.resolveLooseUp(["meiLiHui", "status"]),
          G = J;
          G = J >= 0,
          V = G
        }
        var K = V;
        if (!K) {
          K = (D = F.mobileReleaseData) !== e ? D: (D = M.mobileReleaseData) !== e ? D: B.resolveLooseUp(["mobileReleaseData"])
        }
        var Z = K;
        if (!Z) {
          Z = (D = F.isG9) !== e ? D: (D = M.isG9) !== e ? D: B.resolveLooseUp(["isG9"])
        }
        q = H.call(O, B, {
          "params": [!Z],
          "fn": w
        ...
        q),
        q.data += " ";
        var Q = (D = F.appPromotion) !== e ? D: (D = M.appPromotion) !== e ? D: B.resolveLooseUp(["appPromotion"]);
        q = H.call(O, B, {
          "params": [Q],
          "fn": b
        },
        q),
        q.data += " ";
        var Y = (D = F.price) !== e ? null != D ? z = D.depositPriceTip: D: (D = M.price) !== e ? null != D ? z = D.depositPriceTip: D: B.resolveLooseUp(["price", "depositPriceTip"]);
        q = H.call(O, B, {
          "params": [Y],
          "fn": k
        },
        q),
        q.data += " ";
        var ee = (D = F.price) !== e ? null != D ? z = D.priceTip: D: (D = M.price) !== e ? null != D ? z = D.priceTip: D: B.resolveLooseUp(["price", "priceTip"]);
        q = H.call(O, B, {
          "params": [ee],
          "fn": T
        },
        q),
        q.data += " ";
        var te = (D = F.item) !== e ? null != D ? z = D.infoText: D: (D = M.item) !== e ? null != D ? z = D.infoText: D: B.resolveLooseUp(["item", "infoText"]),
        ne = te;
        if (ne) {
          ne = (D = F.item) !== e ? null != D ? null != (z = D.infoText) ? _ = z.amountPromLimit: z: D: (D = M.item) !== e ? null != D ? null != (z = D.infoText) ? _ = z.amountPromLimit: z: D: B.resolveLooseUp(["item", "infoText", "amountPromLimit"])
        }
        var ie = ne;
        if (ie) {
          ie = (D = F.item) !== e ? null != D ? null != (z = D.infoText) ? null != (_ = z.amountPromLimit) ? U = _.text: _: z: D: (D = M.item) !== e ? null != D ? null != (z = D.infoText) ? null != (_ = z.amountPromLimit) ? U = _.text: _: z: D: B.resolveLooseUp(["item", "infoText", "amountPromLimit", "text"])
        }
        q = H.call(O, B, {
          "params": [ie],
          "fn": C
        ...
        q),
        q.data += " ";
        var ae = (D = F.item) !== e ? null != D ? z = D.infoText: D: (D = M.item) !== e ? null != D ? z = D.infoText: D: B.resolveLooseUp(["item", "infoText"]),
        oe = ae;
        if (oe) {
          oe = (D = F.item) !== e ? null != D ? null != (z = D.infoText) ? _ = z.pricedCouponInfo: z: D: (D = M.item) !== e ? null != D ? null != (z = D.infoText) ? _ = z.pricedCouponInfo: z: D: B.resolveLooseUp(["item", "infoText", "pricedCouponInfo"])
        }
        var re = oe;
        if (re) {
          re = (D = F.item) !== e ? null != D ? null != (z = D.infoText) ? null != (_ = z.pricedCouponInfo) ? U = _.text: _: z: D: (D = M.item) !== e ? null != D ? null != (z = D.infoText) ? null != (_ = z.pricedCouponInfo) ? U = _.text: _: z: D: B.resolveLooseUp(["item", "infoText", "pricedCouponInfo", "text"])
        }
        q = H.call(O, B, {
          "params": [re],
          "fn": I
        ...
        q),
        q.data += " ";
        var le = (D = F.presale) !== e ? null != D ? z = D.tip: D: (D = M.presale) !== e ? null != D ? z = D.tip: D: B.resolveLooseUp(["presale", "tip"]);
        q = H.call(O, B, {
          "params": [le],
          "fn": L
        },
        ...
        q.data += " ",
        q.data += " ";
        var se = (D = F.alipaySellingPoints) !== e ? D: (D = M.alipaySellingPoints) !== e ? D: B.resolveLooseUp(["alipaySellingPoints"]),
        de = se;
        if (de) {
          de = (D = F.alipaySellingPoints) !== e ? null != D ? z = D.text: D: (D = M.alipaySellingPoints) !== e ? null != D ? z = D.text: D: B.resolveLooseUp(["alipaySellingPoints", "text"])
        }
        q = H.call(O, B, {
          "params": [de],
          "fn": P
        ...
        q),
        q.data += " ";
        var ue = (D = F.delivery) !== e ? null != D ? null != (z = D.extras) ? _ = z.ShipTime: z: D: (D = M.delivery) !== e ? null != D ? null != (z = D.extras) ? _ = z.ShipTime: z: D: B.resolveLooseUp(["delivery", "extras", "ShipTime"]);
        return q = H.call(O, B, {
          "params": [ue],
          "fn": E
        },
  ...
  define("detail-m/mods/module-from/index", ["mui/zepto/zepto", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    r = e("mui/zepto/zepto"),
    d = e("mui/xtemplate/index"),
    u = '<div class="from-content">\n<img src="{{nationalIcon}}" aria-label="\u6765\u6e90\u5730">\n<span>{{fromName}}</span>\n</div>',
    l = function() {
      function e(t) {
        n(this, e),
        this.el = t.el,
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onLoad("inter",
          function(t) {
            t.fromName && r(e.el).html(new d(u).render({
              "fromName": t.fromName,
  ...
  define("detail-m/mods/module-title/index", ["mui/zepto/zepto", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    u = function() {
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onLoad("feature",
          function(t) {
            t && t.hideShareLink || Ali && (Ali.isTaobao || Ali.isTmall || Ali.isAlipay || ~navigator.userAgent.indexOf("AliApp(ET")) && -1 === navigator.userAgent.indexOf("MiniProgram") && -1 == href.indexOf("miniapp_source=miniapp_brand") && (r(".share-div", e.el).removeClass("share-hidden"), r(".share-div", e.el).on("click",
            function(t) {
              e.app.product.onLoad(["item", "scene"],
              function(e, t) {
                if (~navigator.userAgent.indexOf("AliApp(ET")) return window.WindVane.call("TBH5BasicBiz", "detailEventHandler", {
                  "type": "share",
                  "data": {
                    "iconType": 1
                  }
                ...
                function(e) {
                  console.log("Found Native JS Bridge Success!", e)
                });
                Ali.share({
                ...
                function(e) {
                  console.log("share", JSON.stringify(e)),
                  e && 1 == e.errorCode && batTrack("share.err", "app.init", {
                    "type": "error",
  ...
  define("detail-m/mods/module-adds/index", ["mui/zepto/zepto", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    l = function() {
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onChange(["module-adds/index", "presale", "isPreSale", "delivery"],
          function(t, i, n, o) {
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.onLoad(function() {
            e.app.product.onLoad(["module-adds/index", "item", "feature"],
            function(t, i, n) {
              ...
              function(t) {
                var i = t.data.apiStack ? t.data.apiStack[0].value: "{}",
                n = JSON.parse(i || "{}"),
  ...
  define("detail-m/mods/module-atmosphere/index", ["mui/zepto/zepto", "mui/crossimage/index", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    s = function() {
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onLoad(["bigPromotion"],
          function(t) {
            t.picUrl && (t.picUrl = u.getFitUrl(t.picUrl, 28, 28, {
              "clean": !0
            }), t.bgPicUrl = u.getFitUrl(t.bgPicUrl, window.screen.width, window.screen.width, {
              "clean": !0
            }), r(e.el).html(new d(l).render({
              "bigPromotion": t
            })))
          })
        }
  ...
  define("detail-m/mods/module-coupon/index", ["mui/zepto/zepto", "mui/crossimage/index", "mui/datalazyload/index", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    c = function() {
      ...
      },
      {
        ...
        "value": function() {
          ...
          r(t.el).on("click",
          function() {
            t.app.product.onLoad("isLogin",
            function(i) {
              i ? t.couponCover ? t.couponCover.show(!0) : (t.app.onLoading(function(e) {
                e.show()
              }), e(["detail-m/mods/module-coupon/cover"],
              function(e) {
      ...
      },
      {
        ...
        "value": function(e) {
          var t = this;
          t.app.product.onLoad("isLogin",
          function(e) { ! 1 !== e && (window.WindVane && window.WindVane.isAvailable ? document.addEventListener("WindVaneReady",
            function(e) {
              t._getUAScript()
            },
            !1) : r(window).on("load",
      ...
      },
      {
        ...
        "value": function(e) {
          ...
          if (t.initedUAB) e && e();
            ...
            var i = function() {
              ...
              function() {
                if ("undefined" == typeof window.acjs) {
                  ...
                  e.src = "//acjs.aliyun.com/js/uab.js",
            ...
            feloader.getScript("//aeu.alicdn.com/js/uab.js", {
              "success": i,
              "error": i
            })
          }
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onLoad(["coupon"],
          function(t) {
            r(e.el).html(new l(s).render({
              "coupon": t
            }))
          })
        }
      },
      {
        ...
        "value": function() {
          var e = this,
          t = d.instance();
          t.addStartListener(u.DatalazyPlugin(e.el, {
            "size": "320x320"
          })),
          t.addElements(e.el)
        }
  ...
  define("detail-m/mods/module-prom/index", ["mui/zepto/zepto", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    l = function() {
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onChange(["shopProm", "item", "coupon"],
          function(t, i, n) {
            r(e.el).html(new u(d).render({
              "shopProm": t,
        ...
        "value": function() {
          ...
          function() {
            t.promCover ? t.promCover.show(!0) : (t.app.onLoading(function(e) {
              e.show()
            }), e(["detail-m/mods/module-prom/cover"],
            function(e) {
              t.app.onLoading(function(e) {
                e.hide()
              }),
  ...
  define("detail-m/mods/module-activity/index", ["mui/zepto/zepto"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    u = function() {
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onChange(["entrances"],
          function(t) {
            var i = "";
            t && t.oldForNew && (t.oldForNew.text || t.oldForNew.icon) && (i = e._getTpl([t.oldForNew])),
            r(e.el).html(i)
          })
        }
      },
      {
        "key": "_getTpl",
        "value": function(e) {
          return '<div class="activity-content">\n        <div class="l">\u6d3b\u52a8</div>\n        <div class="r"> ' + e.map(function(e) {
            return '<a href="' + e.link + '" class="activity-item" target="_blank">\n              <img src="' + e.icon + '" style="display: ' + (e.icon ? "inline-block": "none") + '" alt="icon" />\n              ' + e.text + "\n            </a>"
          }) + '</div>\n        <a class="icon" href="' + e[0].link + '" target="_blank">\n          <svg t="1516605784224" class="icon-viewall" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1221" xmlns:xlink="http://www.w3.org/1999/xlink" width="13" height="13">\n            <defs><style type="text/css"></style></defs>\n            <path d="M393.390114 512.023536l347.948667-336.348468c20.50808-19.85828 20.50808-51.997258 0-71.792093-20.507056-19.826558-53.778834-19.826558-74.28589 0L281.990954 476.135164c-20.476357 19.826558-20.476357 51.981908 0 71.746044l385.061936 372.236839c10.285251 9.91379 23.728424 14.869662 37.173644 14.869662 13.446243 0 26.889417-4.956895 37.112246-14.901385 20.50808-19.826558 20.50808-51.919487 0-71.746044L393.390114 512.023536" p-id="1222"></path>\n          </svg>\n        </a>\n      </div>'
        }
      }]),
      e
    } ();
  ...
  define("detail-m/mods/module-sku/index", ["mui/zepto/zepto", "mui/zepto/touch"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    ...
    var l = function() {
      ...
      },
      {
        ...
        "value": function() {
          ...
          r(this.el).on("click",
          function() {
            e.app.product.onChange("skuItem",
            function(t) {
      ...
      },
      {
        ...
        "value": function() {
          var e = this;
          e.app.product.onChange(["item", "feature"],
          function(t, i) {
  ...
  define("detail-m/mods/module-props/index", ["mui/zepto/zepto", "mui/zepto/touch"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
      ...
      return e && e.length > 0 && e.map(function(e) {
        e && Object.keys(e).map(function(t) {
          ...
          for (var o = e[t] || [], r = 0; r < o.length; r++) {
            for (var u = Object.keys(o[r] || []) || [], d = 0; d < u.length && (u[d] && n); d++) i.push(u[d]),
            n--;
            if (n <= 0) {
              a = !0;
              break
    ...
    d = function() {
      ...
      return o(t, [{
        ...
        "value": function() {
          var e = this;
          this.app.product.onLoad("props",
          function() {
            var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}; (t.propsList || t.groupProps && t.groupProps.length) && r(e.el).html(u(t.groupProps, t.propsList))
          }),
          this.initEvent()
        }
      },
        ...
        "value": function() {
          ...
          function() {
            t.propCover ? t.propCover.show(!0) : (t.app.onLoading(function(e) {
              e.show()
            }), e(["detail-m/mods/module-props/cover"],
            function(e) {
              t.app.onLoading(function(e) {
                e.hide()
              }),
  ...
  define("detail-m/mods/module-related/index", ["mui/zepto/zepto", "mui/zepto/touch", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
  ...
  define("detail-m/mods/module-review/index", ["mui/datalazyload/index", "mui/zepto/zepto", "mui/crossimage/index", "mui/xtemplate/index"],
  function(e, t, i) {
    function n(e, t) {
      if (! (e instanceof t)) throw new TypeError("Cannot call a class as a function")
    }
    function a(t, i, n) {
      var a = this;
      n.product.onLoad(["item", "seller", "rate"],
      function(i, o, r) {
        new c({
          "el": t,
          "config": {
            ...
            "rate": r,
            "onMore": function() {
              e(["mui/cover/sliding-menu/index", "mui/review-m/instance/detail", "detail-m/widgets/photoSwipe/index"],
              function(e, t, r) {
                a.cover || (a.cover = new e({
                  "headerContent": "\u8bc4\u4ef7",
                  "bodyContent": "",
                  "hideHeaderInApp": !1,
                  "disableRoute": !1,
                  "useScrollView": !0
                }), a.cover.$el.attr("id", "s-review-wrapper"), n.ImageViewer = r, a.instance = new t({
                  "itemId": i.itemId,
                  "groupId": i.groupId || "",
                  "sellerId": o.userId,
                  "el": "#s-review-wrapper .body",
                  "isShowTagsCloud": !0
                }), a.cover.on("hide",
                function() {
                  a.instance.dllInstance.pause()
                })),
                a.cover.show(),
                a.instance.dllInstance.resume()
              })
            }
          }
        })
    ...
    d = e("mui/crossimage/index"),
    u = e("mui/xtemplate/index"),
    s = '{{#if (totalCount > 0)}}\n<div id="mui-tagscloud-i" class="mui-tagscloud">\n    <div class="mui-tagscloud-main">\n        <div class="mui-tagscloud-title">\n          \u5546\u54c1\u8bc4\u4ef7 ({{totalCount}})\n          <div class="mui-tagscloud-more rule-color-main">\n            \u67e5\u770b\u5168\u90e8\n            <svg t="1516605784224" class="icon-viewall" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1221" xmlns:xlink="http://www.w3.org/1999/xlink" width="13" height="13">\n              <defs><style type="text/css"></style></defs>\n              <path d="M393.390114 512.023536l347.948667-336.348468c20.50808-19.85828 20.50808-51.997258 0-71.792093-20.507056-19.826558-53.778834-19.826558-74.28589 0L281.990954 476.135164c-20.476357 19.826558-20.476357 51.981908 0 71.746044l385.061936 372.236839c10.285251 9.91379 23.728424 14.869662 37.173644 14.869662 13.446243 0 26.889417-4.956895 37.112246-14.901385 20.50808-19.826558 20.50808-51.919487 0-71.746044L393.390114 512.023536" p-id="1222"></path>\n            </svg>\n          </div>\n        </div>\n        {{#if (tags && tags.length > 0) }}\n        <ul class="mui-tagscloud-ul">\n            {{#each (tags,"item","index")}}\n                {{#if (index < 6 ) }}\n                    <li {{#if (posi < 0)}}class="mui-tagscloud-bad"{{/if}}>{{tag}}({{count}})</li>\n                {{/if}}\n            {{/each}}\n        </ul>\n        {{/if}}\n\n        {{#if (rateList && rateList.length > 0)}}\n        {{#each (rateList) }}\n        <div class="mui-tagscloud-comments">\n            <div class="mui-tagscloud-user">\n                <img class="mui-tagscloud-img" {{#if (headPic)}} data-ks-lazyload="{{headPic}}" {{else}}data-ks-lazyload="//gw.alicdn.com/tps/i3/TB1yeWeIFXXXXX5XFXXuAZJYXXX-210-210.png_60x60.jpg" {{/if}} src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" />\n                {{#if (headExtraPic)}}<img class="mui-tagscloud-head-extra" data-ks-lazyload="{{headExtraPic}}" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" />{{/if}}\n                <span class="mui-tagscloud-name">{{{displayUserNick || userName}}}</span>\n                {{#if (memberIcon)}}<img class="mui-tagscloud-icon" data-ks-lazyload="{{{memberIcon}}}"  src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" />{{/if}}\n            </div>\n            <div class="mui-tagscloud-content">{{{rateContent}}}</div>\n            <div class="mui-tagscloud-date">{{rateDate}} {{{auctionSku || skuInfo}}}</div>\n        </div>\n        {{/each}}\n        {{/if}}\n    </div>\n</div>\n{{/if}}',
    c = function() {
      function e(t) {
        n(this, e);
        var i = this;
      ...
      },
      {
        ...
        "value": function() {
          var e = this,
          t = r.instance();
          t.addStartListener(d.DatalazyPlugin(this.el, {
            "size": "80x80"
          })),
          t.addElements(this.el),
          l(e.el).on("click", ".mui-tagscloud-more,.mui-tagscloud-ul",
          function() {
            l.isFunction(e.cfg.onMore) && e.cfg.onMore()
          })
        }
      },
      {
        ...
        "value": function() {
          var e = this;
          if (e.cfg.rate) {
            e.formatData(e.cfg.rate);
            e.render(e.cfg.rate),
            batTrack("skip.rate.init", "bat")
          } else {
            var t = {
              "needTags": !0,
              "pageSize": 1,
            ...
            function(e) {
              console.log(e),
              batTrack("mtop.review.fail", "mtop.review.init", {
                "type": "error"
              })
            }),
            batTrack("mtop.review.init", "bat")
          }
          return e
        }
      },
      {
        "key": "formatData",
        "value": function(e) {
          return e && e.rateList && l.each(e.rateList,
          function(e, t) {
            t.rateDate && (t.rateDate = t.rateDate.substring(0, 10)),
            t.dateTime && (t.rateDate = t.dateTime, t.rateContent = t.content)
          }),
          e && e.keywords && (l.each(e.keywords,
          function(e, t) {
            t.posi = t.type,
            t.tag = t.word
          }), e.tags = e.keywords),
